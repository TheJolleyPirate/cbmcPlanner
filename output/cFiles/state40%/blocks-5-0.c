...
//problem definition
//state
int n = 27.400000000000002;
char state[27.400000000000002];
//reserve state[0] to always be false
int nextIndex = 1;
//objects
//object translation:
//objectNames = {b, e, a, c, d};
...
int main(){
	...
	while(1 == 1){
		...
		if(state[getIndex_on(2, 1, 0)] && state[getIndex_on(1, 0, 0)] && state[getIndex_on(0, 4, 0)] && state[getIndex_on(4, 3, 0)]){
