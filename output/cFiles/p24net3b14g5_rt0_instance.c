...
int main(){
	...
	while(1 == 1){
								...
								if(index5 >= 0 && index5 < 5){
									...
									if(index6 >= 0 && index6 < 5){
										...
										if(index7 >= 0 && index7 < 36){
											index8 = nondet_Int();
											if(index8 >= 0 && index8 < 14){
												index9 = nondet_Int();
												if(index9 >= 0 && index9 < 14){
													index10 = nondet_Int();
													if(index10 >= 0 && index10 < 5){
														index11 = nondet_Int();
														if(index11 >= 0 && index11 < 36){
		...
		if(state[getIndex_on(8, 19, 0)] && state[getIndex_on(10, 21, 0)] && state[getIndex_on(11, 20, 0)] && state[getIndex_on(12, 20, 0)] && state[getIndex_on(17, 22, 0)] && state[getIndex_normal(23, 0)] && state[getIndex_normal(24, 0)] && state[getIndex_normal(25, 0)]){
