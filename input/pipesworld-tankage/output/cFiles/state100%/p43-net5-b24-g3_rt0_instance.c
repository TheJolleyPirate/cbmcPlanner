...
int main(){
	...
	while(1 == 1){
		...
		if((state[getIndex_on(15, 32, 0)] && state[getIndex_on(18, 32, 0)] && state[getIndex_on(26, 30, 0)] && state[getIndex_normal(34, 0)] && state[getIndex_normal(35, 0)] && state[getIndex_normal(36, 0)] && state[getIndex_normal(37, 0)] && state[getIndex_normal(38, 0)])){
