...
//objects
//object translation:
//objectNames = {lco, gasoleo, rat-a, oca1, oc1b, b10, b0, b1, b4, b6, b7, b9, b3, b8, b2, b11, b5, a1, a2, a3, s12, s13, ta1-3-lco, ta1-2-lco, ta1-1-lco, ta1-1-gasoleo, ta1-1-rat-a, ta1-3-oca1, ta1-2-oca1, ta1-1-oca1, ta1-1-oc1b, ta2-3-lco, ta2-2-lco, ta2-1-lco, ta2-1-gasoleo, ta2-1-rat-a, ta2-3-oca1, ta2-2-oca1, ta2-1-oca1, ta2-1-oc1b, ta3-3-lco, ta3-2-lco, ta3-1-lco, ta3-1-gasoleo, ta3-1-rat-a, ta3-3-oca1, ta3-2-oca1, ta3-1-oca1, ta3-1-oc1b};
...
int main(){
	...
	state[getIndex_tank_slot_product_location(26, 2, 17, 1)] = 1;
	state[getIndex_tank_slot_product_location(27, 3, 17, 1)] = 1;
	state[getIndex_tank_slot_product_location(28, 3, 17, 1)] = 1;
	...
	state[getIndex_tank_slot_product_location(37, 3, 18, 1)] = 1;
	state[getIndex_tank_slot_product_location(38, 3, 18, 1)] = 1;
	...
	state[getIndex_tank_slot_product_location(44, 2, 19, 1)] = 1;
	state[getIndex_tank_slot_product_location(45, 3, 19, 1)] = 1;
	state[getIndex_tank_slot_product_location(46, 3, 19, 1)] = 1;
	state[getIndex_tank_slot_product_location(47, 3, 19, 1)] = 1;
	...
	state[getIndex_on(8, 17, 1)] = 1;
	state[getIndex_occupied(29, 1)] = 1;
	state[getIndex_on(10, 17, 1)] = 1;
	state[getIndex_occupied(28, 1)] = 1;
	state[getIndex_on(13, 19, 1)] = 1;
	state[getIndex_occupied(42, 1)] = 1;
	state[getIndex_on(14, 17, 1)] = 1;
	...
	state[getIndex_first(9, 20, 1)] = 1;
	state[getIndex_follow(15, 9, 1)] = 1;
	state[getIndex_last(15, 20, 1)] = 1;
	state[getIndex_first(11, 21, 1)] = 1;
	state[getIndex_follow(12, 11, 1)] = 1;
	state[getIndex_last(12, 21, 1)] = 1;
	state[getIndex_not_unitary(20, 1)] = 1;
	...
	while(1 == 1){
		...
		if((state[getIndex_on(7, 18, 0)] && state[getIndex_on(11, 19, 0)] && state[getIndex_on(16, 17, 0)] && state[getIndex_normal(20, 0)] && state[getIndex_normal(21, 0)])){
