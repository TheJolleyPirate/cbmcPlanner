...
int main(){
	...
	while(1 == 1){
		...
		if((state[getIndex_on(7, 34, 0)] && state[getIndex_on(13, 36, 0)] && state[getIndex_on(16, 35, 0)] && state[getIndex_on(23, 36, 0)] && state[getIndex_on(31, 34, 0)] && state[getIndex_normal(38, 0)] && state[getIndex_normal(39, 0)] && state[getIndex_normal(40, 0)] && state[getIndex_normal(41, 0)] && state[getIndex_normal(42, 0)])){
