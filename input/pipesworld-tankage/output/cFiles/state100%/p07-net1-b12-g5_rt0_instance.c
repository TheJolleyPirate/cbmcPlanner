...
int main(){
	...
	while(1 == 1){
		...
		if((state[getIndex_on(7, 18, 0)] && state[getIndex_on(8, 17, 0)] && state[getIndex_on(10, 17, 0)] && state[getIndex_on(11, 17, 0)] && state[getIndex_on(15, 17, 0)] && state[getIndex_normal(20, 0)] && state[getIndex_normal(21, 0)])){
