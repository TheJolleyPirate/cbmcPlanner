...
//objects
//object translation:
//objectNames = {b, g, e, d, f, h, i, a, c, j};
...
int main(){
	...
	while(1 == 1){
		...
		if(state[getIndex_on(0, 2, 0)] && state[getIndex_on(2, 6, 0)] && state[getIndex_on(6, 1, 0)] && state[getIndex_on(1, 5, 0)] && state[getIndex_on(5, 8, 0)] && state[getIndex_on(8, 7, 0)] && state[getIndex_on(7, 4, 0)] && state[getIndex_on(4, 9, 0)] && state[getIndex_on(9, 3, 0)]){
