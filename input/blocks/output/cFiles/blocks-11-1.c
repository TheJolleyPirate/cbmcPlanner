...
//objects
//object translation:
//objectNames = {b, c, e, a, h, k, i, g, d, f, j};
...
int main(){
	...
	state[getIndex_clear(9, 1)] = 1;
	state[getIndex_clear(8, 1)] = 1;
	state[getIndex_clear(7, 1)] = 1;
	state[getIndex_ontable(6, 1)] = 1;
	state[getIndex_ontable(5, 1)] = 1;
	state[getIndex_ontable(4, 1)] = 1;
	state[getIndex_ontable(3, 1)] = 1;
	state[getIndex_on(10, 6, 1)] = 1;
	state[getIndex_on(9, 2, 1)] = 1;
	state[getIndex_on(2, 5, 1)] = 1;
	state[getIndex_on(8, 1, 1)] = 1;
	state[getIndex_on(1, 4, 1)] = 1;
	state[getIndex_on(7, 0, 1)] = 1;
	...
	while(1 == 1){
		...
		if(state[getIndex_on(0, 8, 0)] && state[getIndex_on(8, 10, 0)] && state[getIndex_on(10, 5, 0)] && state[getIndex_on(5, 4, 0)] && state[getIndex_on(4, 3, 0)] && state[getIndex_on(3, 1, 0)] && state[getIndex_on(1, 9, 0)] && state[getIndex_on(9, 7, 0)] && state[getIndex_on(7, 6, 0)] && state[getIndex_on(6, 2, 0)]){
