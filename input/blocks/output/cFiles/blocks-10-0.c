...
//objects
//object translation:
//objectNames = {d, a, h, g, b, j, e, i, f, c};
...
int main(){
	...
	while(1 == 1){
		...
		if(state[getIndex_on(0, 9, 0)] && state[getIndex_on(9, 8, 0)] && state[getIndex_on(8, 5, 0)] && state[getIndex_on(5, 6, 0)] && state[getIndex_on(6, 2, 0)] && state[getIndex_on(2, 4, 0)] && state[getIndex_on(4, 1, 0)] && state[getIndex_on(1, 3, 0)] && state[getIndex_on(3, 7, 0)]){
