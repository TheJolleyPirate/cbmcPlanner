...
//objects
//object translation:
//objectNames = {k, a, f, l, d, b, m, e, j, n, h, i, c, g};
...
int main(){
	...
	state[getIndex_on(12, 7, 1)] = 1;
	state[getIndex_on(11, 4, 1)] = 1;
	state[getIndex_on(4, 3, 1)] = 1;
	state[getIndex_on(3, 6, 1)] = 1;
	state[getIndex_on(10, 2, 1)] = 1;
	...
	while(1 == 1){
		...
		if(state[getIndex_on(8, 4, 0)] && state[getIndex_on(4, 5, 0)] && state[getIndex_on(5, 10, 0)] && state[getIndex_on(10, 6, 0)] && state[getIndex_on(6, 0, 0)] && state[getIndex_on(0, 2, 0)] && state[getIndex_on(2, 13, 0)] && state[getIndex_on(13, 1, 0)] && state[getIndex_on(1, 11, 0)] && state[getIndex_on(11, 7, 0)] && state[getIndex_on(7, 3, 0)] && state[getIndex_on(3, 9, 0)] && state[getIndex_on(9, 12, 0)]){
