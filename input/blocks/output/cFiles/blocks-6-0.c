...
int main(){
	...
	state[getIndex_on(5, 1, 1)] = 1;
	state[getIndex_on(1, 3, 1)] = 1;
	state[getIndex_on(4, 0, 1)] = 1;
	...
	while(1 == 1){
		...
		if(state[getIndex_on(3, 2, 0)] && state[getIndex_on(2, 1, 0)] && state[getIndex_on(1, 0, 0)] && state[getIndex_on(0, 4, 0)] && state[getIndex_on(4, 5, 0)]){
