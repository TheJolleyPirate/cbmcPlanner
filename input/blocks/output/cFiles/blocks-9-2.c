...
int main(){
	...
	while(1 == 1){
		...
		if(state[getIndex_on(7, 6, 0)] && state[getIndex_on(6, 8, 0)] && state[getIndex_on(8, 4, 0)] && state[getIndex_on(4, 1, 0)] && state[getIndex_on(1, 3, 0)] && state[getIndex_on(3, 0, 0)] && state[getIndex_on(0, 2, 0)] && state[getIndex_on(2, 5, 0)]){
