...
//objects
//object translation:
//objectNames = {k, c, d, b, i, n, p, j, m, l, g, e, a, o, h, f};
...
int main(){
	...
	while(1 == 1){
		...
		if(state[getIndex_on(2, 3, 0)] && state[getIndex_on(3, 6, 0)] && state[getIndex_on(6, 15, 0)] && state[getIndex_on(15, 10, 0)] && state[getIndex_on(10, 0, 0)] && state[getIndex_on(0, 4, 0)] && state[getIndex_on(4, 9, 0)] && state[getIndex_on(9, 7, 0)] && state[getIndex_on(7, 14, 0)] && state[getIndex_on(14, 12, 0)] && state[getIndex_on(12, 5, 0)] && state[getIndex_on(5, 11, 0)] && state[getIndex_on(11, 8, 0)] && state[getIndex_on(8, 1, 0)] && state[getIndex_on(1, 13, 0)]){
