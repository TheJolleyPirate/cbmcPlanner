...
int main(){
	...
	while(1 == 1){
		...
		if(state[getIndex_on(5, 1, 0)] && state[getIndex_on(1, 6, 0)] && state[getIndex_on(6, 8, 0)] && state[getIndex_on(8, 3, 0)] && state[getIndex_on(3, 2, 0)] && state[getIndex_on(2, 7, 0)] && state[getIndex_on(7, 4, 0)] && state[getIndex_on(4, 0, 0)]){
