...
int main(){
	...
	while(1 == 1){
		...
		if(state[getIndex_on(0, 6, 0)] && state[getIndex_on(6, 4, 0)] && state[getIndex_on(4, 3, 0)] && state[getIndex_on(3, 5, 0)] && state[getIndex_on(5, 2, 0)] && state[getIndex_on(2, 1, 0)]){
