...
//objects
//object translation:
//objectNames = {t, a1, b1, m, o, w, n, c1, d, r, z, p, x, l, a, k, b, j, y, h, d1, e, f, c, v, s, q, u, g, i};
...
int main(){
	...
	state[getIndex_ontable(26, 1)] = 1;
	state[getIndex_ontable(25, 1)] = 1;
	state[getIndex_ontable(27, 1)] = 1;
	state[getIndex_on(29, 24, 1)] = 1;
	state[getIndex_on(24, 23, 1)] = 1;
	state[getIndex_on(23, 22, 1)] = 1;
	state[getIndex_on(22, 21, 1)] = 1;
	state[getIndex_on(21, 20, 1)] = 1;
	state[getIndex_on(20, 19, 1)] = 1;
	...
	while(1 == 1){
		...
		if(state[getIndex_on(25, 10, 0)] && state[getIndex_on(10, 11, 0)] && state[getIndex_on(11, 1, 0)] && state[getIndex_on(1, 27, 0)] && state[getIndex_on(27, 26, 0)] && state[getIndex_on(26, 7, 0)] && state[getIndex_on(7, 29, 0)] && state[getIndex_on(29, 28, 0)] && state[getIndex_on(28, 5, 0)] && state[getIndex_on(5, 8, 0)] && state[getIndex_on(8, 19, 0)] && state[getIndex_on(19, 0, 0)] && state[getIndex_on(0, 13, 0)] && state[getIndex_on(13, 9, 0)] && state[getIndex_on(9, 17, 0)] && state[getIndex_on(17, 20, 0)] && state[getIndex_on(20, 6, 0)] && state[getIndex_on(6, 23, 0)] && state[getIndex_on(23, 24, 0)] && state[getIndex_on(24, 16, 0)] && state[getIndex_on(16, 21, 0)] && state[getIndex_on(21, 12, 0)] && state[getIndex_on(12, 2, 0)] && state[getIndex_on(2, 22, 0)] && state[getIndex_on(22, 18, 0)] && state[getIndex_on(18, 15, 0)] && state[getIndex_on(15, 4, 0)] && state[getIndex_on(4, 3, 0)] && state[getIndex_on(3, 14, 0)]){
