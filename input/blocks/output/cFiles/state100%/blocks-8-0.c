...
//objects
//object translation:
//objectNames = {h, g, f, e, c, b, d, a};
int object[] = {0, 1, 2, 3, 4, 5, 6, 7};
//predicates
int on[8][8];
int ontable[8];
int clear[8];
...
int main(){
	...
	state[getIndex_on(7, 1, 1)] = 1;
	state[getIndex_on(1, 3, 1)] = 1;
	state[getIndex_on(6, 0, 1)] = 1;
	state[getIndex_on(0, 2, 1)] = 1;
	state[getIndex_handempty(1)] = 1;
	...
	while(1 == 1){
		...
		if((state[getIndex_on(6, 2, 0)] && state[getIndex_on(2, 3, 0)] && state[getIndex_on(3, 0, 0)] && state[getIndex_on(0, 4, 0)] && state[getIndex_on(4, 7, 0)] && state[getIndex_on(7, 1, 0)] && state[getIndex_on(1, 5, 0)])){
