...
int main(){
	...
	state[getIndex_on(7, 3, 1)] = 1;
	state[getIndex_on(6, 1, 1)] = 1;
	...
	while(1 == 1){
		...
		if((state[getIndex_on(3, 5, 0)] && state[getIndex_on(5, 0, 0)] && state[getIndex_on(0, 2, 0)] && state[getIndex_on(2, 4, 0)] && state[getIndex_on(4, 6, 0)] && state[getIndex_on(6, 1, 0)] && state[getIndex_on(1, 7, 0)])){
