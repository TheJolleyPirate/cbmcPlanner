...
//objects
//object translation:
//objectNames = {g1, p1, r, k1, h, m1, j1, a, e1, j, x, i, a1, c1, g, c, y, e, w, z, h1, m, q, u, k, d, n, t, s, b, s1, l, n1, v, b1, f1, f, l1, i1, q1, o, r1, p, o1, d1};
...
int main(){
	...
	state[getIndex_on(0, 4, 1)] = 1;
	state[getIndex_on(4, 5, 1)] = 1;
	state[getIndex_on(5, 6, 1)] = 1;
	...
	while(1 == 1){
		...
		if(state[getIndex_on(18, 42, 0)] && state[getIndex_on(42, 22, 0)] && state[getIndex_on(22, 41, 0)] && state[getIndex_on(41, 20, 0)] && state[getIndex_on(20, 28, 0)] && state[getIndex_on(28, 39, 0)] && state[getIndex_on(39, 12, 0)] && state[getIndex_on(12, 6, 0)] && state[getIndex_on(6, 33, 0)] && state[getIndex_on(33, 14, 0)] && state[getIndex_on(14, 3, 0)] && state[getIndex_on(3, 25, 0)] && state[getIndex_on(25, 21, 0)] && state[getIndex_on(21, 17, 0)] && state[getIndex_on(17, 7, 0)] && state[getIndex_on(7, 44, 0)] && state[getIndex_on(44, 36, 0)] && state[getIndex_on(36, 0, 0)] && state[getIndex_on(0, 1, 0)] && state[getIndex_on(1, 15, 0)] && state[getIndex_on(15, 35, 0)] && state[getIndex_on(35, 16, 0)] && state[getIndex_on(16, 31, 0)] && state[getIndex_on(31, 5, 0)] && state[getIndex_on(5, 8, 0)] && state[getIndex_on(8, 29, 0)] && state[getIndex_on(29, 37, 0)] && state[getIndex_on(37, 40, 0)] && state[getIndex_on(40, 19, 0)] && state[getIndex_on(19, 4, 0)] && state[getIndex_on(4, 10, 0)] && state[getIndex_on(10, 24, 0)] && state[getIndex_on(24, 2, 0)] && state[getIndex_on(2, 27, 0)] && state[getIndex_on(27, 11, 0)] && state[getIndex_on(11, 13, 0)] && state[getIndex_on(13, 30, 0)] && state[getIndex_on(30, 43, 0)] && state[getIndex_on(43, 23, 0)] && state[getIndex_on(23, 9, 0)] && state[getIndex_on(9, 34, 0)] && state[getIndex_on(34, 32, 0)] && state[getIndex_on(32, 26, 0)] && state[getIndex_on(26, 38, 0)]){
