...
//objects
//object translation:
//objectNames = {f, e, o, h, d, c, q, m, p, i, r, a, g, k, j, b, s, l, n};
...
int main(){
	...
	while(1 == 1){
		...
		if((state[getIndex_on(3, 6, 0)] && state[getIndex_on(6, 8, 0)] && state[getIndex_on(8, 11, 0)] && state[getIndex_on(11, 17, 0)] && state[getIndex_on(17, 10, 0)] && state[getIndex_on(10, 9, 0)] && state[getIndex_on(9, 4, 0)] && state[getIndex_on(4, 14, 0)] && state[getIndex_on(14, 15, 0)] && state[getIndex_on(15, 18, 0)] && state[getIndex_on(18, 0, 0)] && state[getIndex_on(0, 16, 0)] && state[getIndex_on(16, 7, 0)] && state[getIndex_on(7, 2, 0)] && state[getIndex_on(2, 1, 0)] && state[getIndex_on(1, 5, 0)] && state[getIndex_on(5, 13, 0)] && state[getIndex_on(13, 12, 0)])){
