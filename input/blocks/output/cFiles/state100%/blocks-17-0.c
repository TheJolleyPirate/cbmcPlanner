...
//objects
//object translation:
//objectNames = {c, d, e, f, b, i, j, a, n, o, k, m, p, h, g, l, q};
...
int main(){
	...
	while(1 == 1){
		...
		if((state[getIndex_on(16, 8, 0)] && state[getIndex_on(8, 15, 0)] && state[getIndex_on(15, 9, 0)] && state[getIndex_on(9, 6, 0)] && state[getIndex_on(6, 13, 0)] && state[getIndex_on(13, 0, 0)] && state[getIndex_on(0, 2, 0)] && state[getIndex_on(2, 11, 0)] && state[getIndex_on(11, 12, 0)] && state[getIndex_on(12, 7, 0)] && state[getIndex_on(7, 14, 0)] && state[getIndex_on(14, 4, 0)] && state[getIndex_on(4, 5, 0)] && state[getIndex_on(5, 10, 0)] && state[getIndex_on(10, 3, 0)] && state[getIndex_on(3, 1, 0)])){
