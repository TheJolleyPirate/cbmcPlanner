...
//objects
//object translation:
//objectNames = {h, m, q, d, b, l, o, f, i, r, e, n, p, a, c, k, j, g};
...
int main(){
	...
	while(1 == 1){
		...
		if((state[getIndex_on(0, 17, 0)] && state[getIndex_on(17, 1, 0)] && state[getIndex_on(1, 3, 0)] && state[getIndex_on(3, 4, 0)] && state[getIndex_on(4, 11, 0)] && state[getIndex_on(11, 10, 0)] && state[getIndex_on(10, 7, 0)] && state[getIndex_on(7, 9, 0)] && state[getIndex_on(9, 2, 0)] && state[getIndex_on(2, 6, 0)] && state[getIndex_on(6, 15, 0)] && state[getIndex_on(15, 16, 0)] && state[getIndex_on(16, 8, 0)] && state[getIndex_on(8, 12, 0)] && state[getIndex_on(12, 5, 0)] && state[getIndex_on(5, 14, 0)] && state[getIndex_on(14, 13, 0)])){
