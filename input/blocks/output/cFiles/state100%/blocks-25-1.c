...
//objects
//object translation:
//objectNames = {q, m, j, e, x, o, h, n, p, r, i, c, t, d, w, l, y, b, f, a, g, v, s, u, k};
...
int main(){
	...
	state[getIndex_on(1, 21, 1)] = 1;
	state[getIndex_on(23, 20, 1)] = 1;
	state[getIndex_on(22, 0, 1)] = 1;
	...
	while(1 == 1){
		...
		if(state[getIndex_on(8, 16, 0)] && state[getIndex_on(16, 12, 0)] && state[getIndex_on(12, 9, 0)] && state[getIndex_on(9, 7, 0)] && state[getIndex_on(7, 15, 0)] && state[getIndex_on(15, 23, 0)] && state[getIndex_on(23, 19, 0)] && state[getIndex_on(19, 5, 0)] && state[getIndex_on(5, 13, 0)] && state[getIndex_on(13, 10, 0)] && state[getIndex_on(10, 0, 0)] && state[getIndex_on(0, 11, 0)] && state[getIndex_on(11, 1, 0)] && state[getIndex_on(1, 6, 0)] && state[getIndex_on(6, 20, 0)] && state[getIndex_on(20, 17, 0)] && state[getIndex_on(17, 21, 0)] && state[getIndex_on(21, 3, 0)] && state[getIndex_on(3, 2, 0)] && state[getIndex_on(2, 22, 0)] && state[getIndex_on(22, 4, 0)] && state[getIndex_on(4, 24, 0)] && state[getIndex_on(24, 18, 0)] && state[getIndex_on(18, 14, 0)]){
