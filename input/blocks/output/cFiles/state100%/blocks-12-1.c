...
//objects
//object translation:
//objectNames = {e, l, a, b, f, i, h, g, d, j, k, c};
...
int main(){
	...
	while(1 == 1){
		...
		if((state[getIndex_on(9, 11, 0)] && state[getIndex_on(11, 0, 0)] && state[getIndex_on(0, 10, 0)] && state[getIndex_on(10, 6, 0)] && state[getIndex_on(6, 2, 0)] && state[getIndex_on(2, 4, 0)] && state[getIndex_on(4, 1, 0)] && state[getIndex_on(1, 7, 0)] && state[getIndex_on(7, 3, 0)] && state[getIndex_on(3, 5, 0)] && state[getIndex_on(5, 8, 0)])){
