...
int main(){
	...
	while(1 == 1){
		...
		if((state[getIndex_on(6, 0, 0)] && state[getIndex_on(0, 1, 0)] && state[getIndex_on(1, 3, 0)] && state[getIndex_on(3, 4, 0)] && state[getIndex_on(4, 5, 0)] && state[getIndex_on(5, 2, 0)])){
