...
//objects
//object translation:
//objectNames = {f, a, k, h, g, e, d, i, c, j, b};
...
int main(){
	...
	state[getIndex_on(9, 6, 1)] = 1;
	state[getIndex_on(8, 5, 1)] = 1;
	state[getIndex_handempty(1)] = 1;
	...
	while(1 == 1){
		...
		if((state[getIndex_on(1, 9, 0)] && state[getIndex_on(9, 6, 0)] && state[getIndex_on(6, 10, 0)] && state[getIndex_on(10, 3, 0)] && state[getIndex_on(3, 2, 0)] && state[getIndex_on(2, 7, 0)] && state[getIndex_on(7, 0, 0)] && state[getIndex_on(0, 5, 0)] && state[getIndex_on(5, 4, 0)] && state[getIndex_on(4, 8, 0)])){
