...
//objects
//object translation:
//objectNames = {i, m, g, h, l, a, c, d, e, k, f, b, j};
...
int main(){
	...
	while(1 == 1){
		...
		if(state[getIndex_on(7, 5, 0)] && state[getIndex_on(5, 8, 0)] && state[getIndex_on(8, 4, 0)] && state[getIndex_on(4, 1, 0)] && state[getIndex_on(1, 6, 0)] && state[getIndex_on(6, 12, 0)] && state[getIndex_on(12, 10, 0)] && state[getIndex_on(10, 9, 0)] && state[getIndex_on(9, 2, 0)] && state[getIndex_on(2, 3, 0)] && state[getIndex_on(3, 0, 0)] && state[getIndex_on(0, 11, 0)]){
