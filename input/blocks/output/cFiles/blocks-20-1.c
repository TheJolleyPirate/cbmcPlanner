...
//objects
//object translation:
//objectNames = {r, f, c, s, j, o, d, l, p, b, i, e, t, q, k, h, m, n, g, a};
...
int main(){
	...
	state[getIndex_ontable(17, 1)] = 1;
	state[getIndex_ontable(16, 1)] = 1;
	state[getIndex_on(19, 15, 1)] = 1;
	...
	state[getIndex_on(0, 17, 1)] = 1;
	state[getIndex_on(18, 16, 1)] = 1;
	state[getIndex_handempty(1)] = 1;
	...
	while(1 == 1){
		...
		if(state[getIndex_on(15, 17, 0)] && state[getIndex_on(17, 19, 0)] && state[getIndex_on(19, 13, 0)] && state[getIndex_on(13, 10, 0)] && state[getIndex_on(10, 5, 0)] && state[getIndex_on(5, 3, 0)] && state[getIndex_on(3, 6, 0)] && state[getIndex_on(6, 2, 0)] && state[getIndex_on(2, 14, 0)] && state[getIndex_on(14, 8, 0)] && state[getIndex_on(8, 7, 0)] && state[getIndex_on(7, 4, 0)] && state[getIndex_on(4, 12, 0)] && state[getIndex_on(12, 18, 0)] && state[getIndex_on(18, 16, 0)] && state[getIndex_on(16, 1, 0)] && state[getIndex_on(1, 9, 0)] && state[getIndex_on(9, 0, 0)] && state[getIndex_on(0, 11, 0)]){
