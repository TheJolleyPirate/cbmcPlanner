...
//objects
//object translation:
//objectNames = {e, j, d, c, f, k, h, g, a, i, b};
...
int main(){
	...
	while(1 == 1){
		...
		if(state[getIndex_on(9, 7, 0)] && state[getIndex_on(7, 3, 0)] && state[getIndex_on(3, 2, 0)] && state[getIndex_on(2, 0, 0)] && state[getIndex_on(0, 1, 0)] && state[getIndex_on(1, 10, 0)] && state[getIndex_on(10, 6, 0)] && state[getIndex_on(6, 8, 0)] && state[getIndex_on(8, 4, 0)] && state[getIndex_on(4, 5, 0)]){
