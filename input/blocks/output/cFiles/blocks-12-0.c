...
//objects
//object translation:
//objectNames = {i, d, b, e, k, g, a, f, c, j, l, h};
...
int main(){
	...
	while(1 == 1){
		...
		if(state[getIndex_on(0, 8, 0)] && state[getIndex_on(8, 2, 0)] && state[getIndex_on(2, 10, 0)] && state[getIndex_on(10, 1, 0)] && state[getIndex_on(1, 9, 0)] && state[getIndex_on(9, 3, 0)] && state[getIndex_on(3, 4, 0)] && state[getIndex_on(4, 7, 0)] && state[getIndex_on(7, 6, 0)] && state[getIndex_on(6, 11, 0)] && state[getIndex_on(11, 5, 0)]){
