...
//objects
//object translation:
//objectNames = {j, b, k, a, d, h, e, n, c, f, l, m, i, o, g};
...
int main(){
	...
	while(1 == 1){
		...
		if(state[getIndex_on(4, 14, 0)] && state[getIndex_on(14, 9, 0)] && state[getIndex_on(9, 2, 0)] && state[getIndex_on(2, 0, 0)] && state[getIndex_on(0, 6, 0)] && state[getIndex_on(6, 11, 0)] && state[getIndex_on(11, 3, 0)] && state[getIndex_on(3, 1, 0)] && state[getIndex_on(1, 8, 0)] && state[getIndex_on(8, 7, 0)] && state[getIndex_on(7, 13, 0)] && state[getIndex_on(13, 12, 0)] && state[getIndex_on(12, 10, 0)] && state[getIndex_on(10, 5, 0)]){
