...
//objects
//object translation:
//objectNames = {d, o, c, t, m, h, w, n, j1, h1, a, m1, j, g1, i1, q, b, p, l, v, f1, y, k1, n1, d1, z, x, s, e, c1, r, u, k, e1, b1, g, a1, f, i, l1};
...
int main(){
	...
	while(1 == 1){
		...
		if(state[getIndex_on(10, 34, 0)] && state[getIndex_on(34, 27, 0)] && state[getIndex_on(27, 14, 0)] && state[getIndex_on(14, 36, 0)] && state[getIndex_on(36, 21, 0)] && state[getIndex_on(21, 30, 0)] && state[getIndex_on(30, 32, 0)] && state[getIndex_on(32, 8, 0)] && state[getIndex_on(8, 0, 0)] && state[getIndex_on(0, 7, 0)] && state[getIndex_on(7, 37, 0)] && state[getIndex_on(37, 35, 0)] && state[getIndex_on(35, 28, 0)] && state[getIndex_on(28, 23, 0)] && state[getIndex_on(23, 3, 0)] && state[getIndex_on(3, 31, 0)] && state[getIndex_on(31, 2, 0)] && state[getIndex_on(2, 39, 0)] && state[getIndex_on(39, 24, 0)] && state[getIndex_on(24, 17, 0)] && state[getIndex_on(17, 19, 0)] && state[getIndex_on(19, 15, 0)] && state[getIndex_on(15, 11, 0)] && state[getIndex_on(11, 5, 0)] && state[getIndex_on(5, 22, 0)] && state[getIndex_on(22, 33, 0)] && state[getIndex_on(33, 6, 0)] && state[getIndex_on(6, 20, 0)] && state[getIndex_on(20, 1, 0)] && state[getIndex_on(1, 12, 0)] && state[getIndex_on(12, 25, 0)] && state[getIndex_on(25, 29, 0)] && state[getIndex_on(29, 4, 0)] && state[getIndex_on(4, 26, 0)] && state[getIndex_on(26, 18, 0)] && state[getIndex_on(18, 9, 0)] && state[getIndex_on(9, 16, 0)] && state[getIndex_on(16, 38, 0)] && state[getIndex_on(38, 13, 0)]){
