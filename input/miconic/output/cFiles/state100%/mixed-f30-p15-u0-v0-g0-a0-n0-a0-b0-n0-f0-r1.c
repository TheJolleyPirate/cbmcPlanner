...
int main(){
	...
	state[getIndex_origin(11, 20, 1)] = 1;
	state[getIndex_destin(11, 21, 1)] = 1;
	state[getIndex_origin(12, 28, 1)] = 1;
	state[getIndex_destin(12, 16, 1)] = 1;
