...
int main(){
	...
	state[getIndex_origin(1, 23, 1)] = 1;
	state[getIndex_destin(1, 33, 1)] = 1;
	state[getIndex_origin(2, 15, 1)] = 1;
	state[getIndex_destin(2, 17, 1)] = 1;
	state[getIndex_origin(3, 24, 1)] = 1;
	...
	state[getIndex_origin(9, 30, 1)] = 1;
	state[getIndex_destin(9, 17, 1)] = 1;
	state[getIndex_origin(10, 14, 1)] = 1;
	state[getIndex_destin(10, 33, 1)] = 1;
	state[getIndex_origin(11, 23, 1)] = 1;
	state[getIndex_destin(11, 16, 1)] = 1;
	state[getIndex_origin(12, 40, 1)] = 1;
	state[getIndex_destin(12, 41, 1)] = 1;
	state[getIndex_origin(13, 29, 1)] = 1;
