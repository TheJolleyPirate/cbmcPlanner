...
int main(){
	...
	state[getIndex_origin(0, 35, 1)] = 1;
	state[getIndex_destin(0, 41, 1)] = 1;
	state[getIndex_origin(1, 28, 1)] = 1;
	state[getIndex_destin(1, 65, 1)] = 1;
	state[getIndex_origin(2, 45, 1)] = 1;
	state[getIndex_destin(2, 30, 1)] = 1;
	state[getIndex_origin(3, 39, 1)] = 1;
	state[getIndex_destin(3, 34, 1)] = 1;
	state[getIndex_origin(4, 37, 1)] = 1;
	state[getIndex_destin(4, 62, 1)] = 1;
	state[getIndex_origin(5, 53, 1)] = 1;
	state[getIndex_destin(5, 52, 1)] = 1;
	state[getIndex_origin(6, 50, 1)] = 1;
	state[getIndex_destin(6, 32, 1)] = 1;
	state[getIndex_origin(7, 40, 1)] = 1;
	state[getIndex_destin(7, 33, 1)] = 1;
	state[getIndex_origin(8, 30, 1)] = 1;
	state[getIndex_destin(8, 53, 1)] = 1;
	state[getIndex_origin(9, 36, 1)] = 1;
	state[getIndex_destin(9, 26, 1)] = 1;
	state[getIndex_origin(10, 58, 1)] = 1;
	state[getIndex_destin(10, 55, 1)] = 1;
	state[getIndex_origin(11, 58, 1)] = 1;
	state[getIndex_destin(11, 33, 1)] = 1;
	state[getIndex_origin(12, 54, 1)] = 1;
	state[getIndex_destin(12, 48, 1)] = 1;
	state[getIndex_origin(13, 64, 1)] = 1;
	state[getIndex_destin(13, 48, 1)] = 1;
	state[getIndex_origin(14, 51, 1)] = 1;
	state[getIndex_destin(14, 47, 1)] = 1;
	state[getIndex_origin(15, 37, 1)] = 1;
	state[getIndex_destin(15, 64, 1)] = 1;
	state[getIndex_origin(16, 22, 1)] = 1;
	state[getIndex_destin(16, 63, 1)] = 1;
	state[getIndex_origin(17, 40, 1)] = 1;
	state[getIndex_destin(17, 22, 1)] = 1;
	state[getIndex_origin(18, 27, 1)] = 1;
	state[getIndex_destin(18, 57, 1)] = 1;
	state[getIndex_origin(19, 54, 1)] = 1;
	state[getIndex_destin(19, 43, 1)] = 1;
	state[getIndex_origin(20, 53, 1)] = 1;
	state[getIndex_destin(20, 42, 1)] = 1;
	state[getIndex_origin(21, 29, 1)] = 1;
	state[getIndex_destin(21, 57, 1)] = 1;
