...
int main(){
	...
	state[getIndex_destin(0, 51, 1)] = 1;
	state[getIndex_origin(1, 22, 1)] = 1;
	state[getIndex_destin(1, 40, 1)] = 1;
	state[getIndex_origin(2, 42, 1)] = 1;
	state[getIndex_destin(2, 58, 1)] = 1;
	state[getIndex_origin(3, 47, 1)] = 1;
	state[getIndex_destin(3, 25, 1)] = 1;
	state[getIndex_origin(4, 29, 1)] = 1;
	state[getIndex_destin(4, 44, 1)] = 1;
	state[getIndex_origin(5, 50, 1)] = 1;
	state[getIndex_destin(5, 49, 1)] = 1;
	state[getIndex_origin(6, 42, 1)] = 1;
	state[getIndex_destin(6, 39, 1)] = 1;
	state[getIndex_origin(7, 58, 1)] = 1;
	state[getIndex_destin(7, 33, 1)] = 1;
	state[getIndex_origin(8, 40, 1)] = 1;
	state[getIndex_destin(8, 53, 1)] = 1;
	state[getIndex_origin(9, 43, 1)] = 1;
	state[getIndex_destin(9, 29, 1)] = 1;
	state[getIndex_origin(10, 38, 1)] = 1;
	state[getIndex_destin(10, 53, 1)] = 1;
	state[getIndex_origin(11, 48, 1)] = 1;
	state[getIndex_destin(11, 22, 1)] = 1;
	state[getIndex_origin(12, 47, 1)] = 1;
	state[getIndex_destin(12, 20, 1)] = 1;
	state[getIndex_origin(13, 27, 1)] = 1;
	state[getIndex_destin(13, 59, 1)] = 1;
	state[getIndex_origin(14, 38, 1)] = 1;
	state[getIndex_destin(14, 50, 1)] = 1;
	state[getIndex_origin(15, 27, 1)] = 1;
	state[getIndex_destin(15, 29, 1)] = 1;
	state[getIndex_origin(16, 52, 1)] = 1;
	state[getIndex_destin(16, 29, 1)] = 1;
	state[getIndex_origin(17, 41, 1)] = 1;
	state[getIndex_destin(17, 27, 1)] = 1;
	state[getIndex_origin(18, 20, 1)] = 1;
	state[getIndex_destin(18, 32, 1)] = 1;
	state[getIndex_origin(19, 21, 1)] = 1;
	state[getIndex_destin(19, 44, 1)] = 1;
