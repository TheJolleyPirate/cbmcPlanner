...
int main(){
	...
	state[getIndex_origin(0, 34, 1)] = 1;
	state[getIndex_destin(0, 23, 1)] = 1;
	state[getIndex_origin(1, 52, 1)] = 1;
	state[getIndex_destin(1, 48, 1)] = 1;
	state[getIndex_origin(2, 52, 1)] = 1;
	state[getIndex_destin(2, 46, 1)] = 1;
	state[getIndex_origin(3, 37, 1)] = 1;
	state[getIndex_destin(3, 47, 1)] = 1;
	state[getIndex_origin(4, 34, 1)] = 1;
	state[getIndex_destin(4, 24, 1)] = 1;
	state[getIndex_origin(5, 63, 1)] = 1;
	state[getIndex_destin(5, 62, 1)] = 1;
	state[getIndex_origin(6, 29, 1)] = 1;
	state[getIndex_destin(6, 40, 1)] = 1;
	state[getIndex_origin(7, 32, 1)] = 1;
	state[getIndex_destin(7, 63, 1)] = 1;
	state[getIndex_origin(8, 61, 1)] = 1;
	state[getIndex_destin(8, 33, 1)] = 1;
	state[getIndex_origin(9, 31, 1)] = 1;
	state[getIndex_destin(9, 35, 1)] = 1;
	state[getIndex_origin(10, 62, 1)] = 1;
	state[getIndex_destin(10, 57, 1)] = 1;
	...
	state[getIndex_origin(13, 53, 1)] = 1;
	state[getIndex_destin(13, 50, 1)] = 1;
	state[getIndex_origin(14, 62, 1)] = 1;
	state[getIndex_destin(14, 50, 1)] = 1;
	state[getIndex_origin(15, 68, 1)] = 1;
	state[getIndex_destin(15, 67, 1)] = 1;
	state[getIndex_origin(16, 51, 1)] = 1;
	state[getIndex_destin(16, 45, 1)] = 1;
	state[getIndex_origin(17, 40, 1)] = 1;
	state[getIndex_destin(17, 28, 1)] = 1;
	state[getIndex_origin(18, 68, 1)] = 1;
	state[getIndex_destin(18, 55, 1)] = 1;
	state[getIndex_origin(19, 46, 1)] = 1;
	state[getIndex_destin(19, 33, 1)] = 1;
	state[getIndex_origin(20, 50, 1)] = 1;
	state[getIndex_destin(20, 40, 1)] = 1;
	state[getIndex_origin(21, 66, 1)] = 1;
	state[getIndex_destin(21, 56, 1)] = 1;
	state[getIndex_origin(22, 51, 1)] = 1;
	state[getIndex_destin(22, 24, 1)] = 1;
