...
int main(){
	...
	state[getIndex_destin(3, 22, 1)] = 1;
	state[getIndex_origin(4, 19, 1)] = 1;
	state[getIndex_destin(4, 11, 1)] = 1;
	state[getIndex_origin(5, 12, 1)] = 1;
	state[getIndex_destin(5, 17, 1)] = 1;
	state[getIndex_origin(6, 20, 1)] = 1;
	state[getIndex_destin(6, 29, 1)] = 1;
	state[getIndex_origin(7, 13, 1)] = 1;
	state[getIndex_destin(7, 16, 1)] = 1;
	state[getIndex_origin(8, 10, 1)] = 1;
	state[getIndex_destin(8, 16, 1)] = 1;
