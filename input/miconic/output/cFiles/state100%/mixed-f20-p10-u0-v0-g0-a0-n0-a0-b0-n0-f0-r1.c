...
int main(){
	...
	state[getIndex_origin(0, 10, 1)] = 1;
	state[getIndex_destin(0, 11, 1)] = 1;
	state[getIndex_origin(1, 29, 1)] = 1;
	state[getIndex_destin(1, 14, 1)] = 1;
	state[getIndex_origin(2, 26, 1)] = 1;
	state[getIndex_destin(2, 13, 1)] = 1;
	state[getIndex_origin(3, 15, 1)] = 1;
	state[getIndex_destin(3, 20, 1)] = 1;
	state[getIndex_origin(4, 11, 1)] = 1;
	state[getIndex_destin(4, 21, 1)] = 1;
	state[getIndex_origin(5, 10, 1)] = 1;
	state[getIndex_destin(5, 18, 1)] = 1;
	state[getIndex_origin(6, 27, 1)] = 1;
	state[getIndex_destin(6, 17, 1)] = 1;
	state[getIndex_origin(7, 20, 1)] = 1;
	state[getIndex_destin(7, 11, 1)] = 1;
