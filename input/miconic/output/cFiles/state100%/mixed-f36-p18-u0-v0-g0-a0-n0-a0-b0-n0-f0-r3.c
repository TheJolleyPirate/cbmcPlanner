...
int main(){
	...
	state[getIndex_origin(0, 47, 1)] = 1;
	state[getIndex_destin(0, 29, 1)] = 1;
	state[getIndex_origin(1, 36, 1)] = 1;
	state[getIndex_destin(1, 49, 1)] = 1;
	state[getIndex_origin(2, 21, 1)] = 1;
	state[getIndex_destin(2, 42, 1)] = 1;
	state[getIndex_origin(3, 23, 1)] = 1;
	state[getIndex_destin(3, 42, 1)] = 1;
	state[getIndex_origin(4, 33, 1)] = 1;
	state[getIndex_destin(4, 50, 1)] = 1;
	state[getIndex_origin(5, 25, 1)] = 1;
	state[getIndex_destin(5, 24, 1)] = 1;
	state[getIndex_origin(6, 34, 1)] = 1;
	state[getIndex_destin(6, 48, 1)] = 1;
	state[getIndex_origin(7, 40, 1)] = 1;
	state[getIndex_destin(7, 37, 1)] = 1;
	state[getIndex_origin(8, 26, 1)] = 1;
	state[getIndex_destin(8, 37, 1)] = 1;
	state[getIndex_origin(9, 44, 1)] = 1;
	state[getIndex_destin(9, 30, 1)] = 1;
	state[getIndex_origin(10, 34, 1)] = 1;
	state[getIndex_destin(10, 47, 1)] = 1;
	state[getIndex_origin(11, 30, 1)] = 1;
	state[getIndex_destin(11, 41, 1)] = 1;
	state[getIndex_origin(12, 34, 1)] = 1;
	state[getIndex_destin(12, 52, 1)] = 1;
	state[getIndex_origin(13, 28, 1)] = 1;
	state[getIndex_destin(13, 24, 1)] = 1;
	state[getIndex_origin(14, 47, 1)] = 1;
	state[getIndex_destin(14, 23, 1)] = 1;
	state[getIndex_origin(15, 53, 1)] = 1;
	state[getIndex_destin(15, 40, 1)] = 1;
	state[getIndex_origin(16, 34, 1)] = 1;
	state[getIndex_destin(16, 51, 1)] = 1;
	state[getIndex_origin(17, 52, 1)] = 1;
	state[getIndex_destin(17, 18, 1)] = 1;
