...
int main(){
	...
	state[getIndex_origin(4, 12, 1)] = 1;
	state[getIndex_destin(4, 11, 1)] = 1;
	state[getIndex_origin(5, 11, 1)] = 1;
	state[getIndex_destin(5, 10, 1)] = 1;
	state[getIndex_origin(6, 11, 1)] = 1;
	state[getIndex_destin(6, 12, 1)] = 1;
	state[getIndex_origin(7, 9, 1)] = 1;
	state[getIndex_destin(7, 24, 1)] = 1;
	state[getIndex_origin(8, 11, 1)] = 1;
