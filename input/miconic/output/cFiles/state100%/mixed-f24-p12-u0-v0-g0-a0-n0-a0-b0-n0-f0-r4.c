...
int main(){
	...
	state[getIndex_origin(6, 26, 1)] = 1;
	state[getIndex_destin(6, 15, 1)] = 1;
	state[getIndex_origin(7, 18, 1)] = 1;
	state[getIndex_destin(7, 33, 1)] = 1;
	state[getIndex_origin(8, 32, 1)] = 1;
	state[getIndex_destin(8, 13, 1)] = 1;
	state[getIndex_origin(9, 19, 1)] = 1;
	state[getIndex_destin(9, 13, 1)] = 1;
	state[getIndex_origin(10, 30, 1)] = 1;
	state[getIndex_destin(10, 13, 1)] = 1;
	state[getIndex_origin(11, 16, 1)] = 1;
	state[getIndex_destin(11, 30, 1)] = 1;
