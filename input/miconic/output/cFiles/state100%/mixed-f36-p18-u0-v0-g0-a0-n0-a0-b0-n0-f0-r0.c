...
int main(){
	...
	state[getIndex_destin(0, 52, 1)] = 1;
	state[getIndex_origin(1, 27, 1)] = 1;
	state[getIndex_destin(1, 25, 1)] = 1;
	state[getIndex_origin(2, 23, 1)] = 1;
	state[getIndex_destin(2, 25, 1)] = 1;
	state[getIndex_origin(3, 28, 1)] = 1;
	state[getIndex_destin(3, 30, 1)] = 1;
	state[getIndex_origin(4, 51, 1)] = 1;
	state[getIndex_destin(4, 19, 1)] = 1;
	state[getIndex_origin(5, 32, 1)] = 1;
	state[getIndex_destin(5, 49, 1)] = 1;
	state[getIndex_origin(6, 32, 1)] = 1;
	state[getIndex_destin(6, 25, 1)] = 1;
	state[getIndex_origin(7, 41, 1)] = 1;
	state[getIndex_destin(7, 40, 1)] = 1;
	state[getIndex_origin(8, 42, 1)] = 1;
	state[getIndex_destin(8, 36, 1)] = 1;
	state[getIndex_origin(9, 34, 1)] = 1;
	state[getIndex_destin(9, 46, 1)] = 1;
	state[getIndex_origin(10, 53, 1)] = 1;
	state[getIndex_destin(10, 26, 1)] = 1;
	state[getIndex_origin(11, 33, 1)] = 1;
	state[getIndex_destin(11, 51, 1)] = 1;
	state[getIndex_origin(12, 44, 1)] = 1;
	state[getIndex_destin(12, 49, 1)] = 1;
	state[getIndex_origin(13, 37, 1)] = 1;
	state[getIndex_destin(13, 23, 1)] = 1;
	state[getIndex_origin(14, 36, 1)] = 1;
	state[getIndex_destin(14, 48, 1)] = 1;
	state[getIndex_origin(15, 23, 1)] = 1;
	state[getIndex_destin(15, 21, 1)] = 1;
	state[getIndex_origin(16, 19, 1)] = 1;
	state[getIndex_destin(16, 34, 1)] = 1;
	state[getIndex_origin(17, 49, 1)] = 1;
	state[getIndex_destin(17, 52, 1)] = 1;
