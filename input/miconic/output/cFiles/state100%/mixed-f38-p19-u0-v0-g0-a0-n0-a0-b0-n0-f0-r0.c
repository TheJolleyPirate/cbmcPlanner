...
int main(){
	...
	state[getIndex_origin(2, 46, 1)] = 1;
	...
	state[getIndex_destin(10, 46, 1)] = 1;
	state[getIndex_origin(11, 50, 1)] = 1;
	state[getIndex_destin(11, 45, 1)] = 1;
	state[getIndex_origin(12, 31, 1)] = 1;
	state[getIndex_destin(12, 25, 1)] = 1;
	state[getIndex_origin(13, 26, 1)] = 1;
	...
	state[getIndex_origin(16, 25, 1)] = 1;
