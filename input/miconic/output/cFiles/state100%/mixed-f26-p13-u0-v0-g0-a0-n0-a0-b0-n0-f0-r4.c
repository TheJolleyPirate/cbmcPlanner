...
int main(){
	...
	state[getIndex_origin(0, 18, 1)] = 1;
	state[getIndex_destin(0, 20, 1)] = 1;
	state[getIndex_origin(1, 17, 1)] = 1;
	state[getIndex_destin(1, 21, 1)] = 1;
	...
	state[getIndex_destin(12, 15, 1)] = 1;
