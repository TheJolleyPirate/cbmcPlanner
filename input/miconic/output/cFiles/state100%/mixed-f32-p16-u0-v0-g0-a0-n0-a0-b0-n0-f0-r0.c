...
int main(){
	...
	state[getIndex_destin(0, 22, 1)] = 1;
	state[getIndex_origin(1, 25, 1)] = 1;
	state[getIndex_destin(1, 35, 1)] = 1;
	state[getIndex_origin(2, 33, 1)] = 1;
	state[getIndex_destin(2, 47, 1)] = 1;
	state[getIndex_origin(3, 26, 1)] = 1;
	...
	state[getIndex_origin(12, 38, 1)] = 1;
	state[getIndex_destin(12, 42, 1)] = 1;
	state[getIndex_origin(13, 30, 1)] = 1;
	state[getIndex_destin(13, 19, 1)] = 1;
	state[getIndex_origin(14, 35, 1)] = 1;
	state[getIndex_destin(14, 47, 1)] = 1;
	state[getIndex_origin(15, 25, 1)] = 1;
	state[getIndex_destin(15, 42, 1)] = 1;
