...
int main(){
	...
	state[getIndex_origin(1, 42, 1)] = 1;
	state[getIndex_destin(1, 40, 1)] = 1;
	state[getIndex_origin(2, 38, 1)] = 1;
	state[getIndex_destin(2, 40, 1)] = 1;
	state[getIndex_origin(3, 31, 1)] = 1;
	state[getIndex_destin(3, 27, 1)] = 1;
	...
	state[getIndex_origin(7, 38, 1)] = 1;
	state[getIndex_destin(7, 31, 1)] = 1;
	state[getIndex_origin(8, 15, 1)] = 1;
	state[getIndex_destin(8, 21, 1)] = 1;
	...
	state[getIndex_origin(11, 42, 1)] = 1;
	...
	state[getIndex_destin(14, 40, 1)] = 1;
