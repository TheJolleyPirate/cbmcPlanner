...
int main(){
	...
	state[getIndex_destin(0, 10, 1)] = 1;
	state[getIndex_origin(1, 14, 1)] = 1;
	state[getIndex_destin(1, 12, 1)] = 1;
	...
	state[getIndex_destin(5, 21, 1)] = 1;
	state[getIndex_origin(6, 12, 1)] = 1;
	state[getIndex_destin(6, 16, 1)] = 1;
	state[getIndex_origin(7, 24, 1)] = 1;
	state[getIndex_destin(7, 15, 1)] = 1;
	state[getIndex_origin(8, 25, 1)] = 1;
	state[getIndex_destin(8, 14, 1)] = 1;
	state[getIndex_origin(9, 10, 1)] = 1;
