...
int main(){
	...
	state[getIndex_origin(0, 61, 1)] = 1;
	state[getIndex_destin(0, 32, 1)] = 1;
	state[getIndex_origin(1, 39, 1)] = 1;
	state[getIndex_destin(1, 57, 1)] = 1;
	state[getIndex_origin(2, 23, 1)] = 1;
	state[getIndex_destin(2, 37, 1)] = 1;
	state[getIndex_origin(3, 44, 1)] = 1;
	state[getIndex_destin(3, 50, 1)] = 1;
	state[getIndex_origin(4, 47, 1)] = 1;
	state[getIndex_destin(4, 23, 1)] = 1;
	state[getIndex_origin(5, 52, 1)] = 1;
	state[getIndex_destin(5, 29, 1)] = 1;
	state[getIndex_origin(6, 60, 1)] = 1;
	state[getIndex_destin(6, 25, 1)] = 1;
	state[getIndex_origin(7, 29, 1)] = 1;
	state[getIndex_destin(7, 48, 1)] = 1;
	state[getIndex_origin(8, 42, 1)] = 1;
	state[getIndex_destin(8, 32, 1)] = 1;
	state[getIndex_origin(9, 46, 1)] = 1;
	state[getIndex_destin(9, 22, 1)] = 1;
	state[getIndex_origin(10, 65, 1)] = 1;
	state[getIndex_destin(10, 30, 1)] = 1;
	state[getIndex_origin(11, 49, 1)] = 1;
	state[getIndex_destin(11, 55, 1)] = 1;
	state[getIndex_origin(12, 48, 1)] = 1;
	state[getIndex_destin(12, 28, 1)] = 1;
	state[getIndex_origin(13, 44, 1)] = 1;
	state[getIndex_destin(13, 65, 1)] = 1;
	state[getIndex_origin(14, 25, 1)] = 1;
	state[getIndex_destin(14, 65, 1)] = 1;
	state[getIndex_origin(15, 43, 1)] = 1;
	state[getIndex_destin(15, 40, 1)] = 1;
	state[getIndex_origin(16, 32, 1)] = 1;
	state[getIndex_destin(16, 36, 1)] = 1;
	state[getIndex_origin(17, 51, 1)] = 1;
	state[getIndex_destin(17, 53, 1)] = 1;
	state[getIndex_origin(18, 51, 1)] = 1;
	state[getIndex_destin(18, 30, 1)] = 1;
	state[getIndex_origin(19, 57, 1)] = 1;
	state[getIndex_destin(19, 32, 1)] = 1;
	state[getIndex_origin(20, 51, 1)] = 1;
	state[getIndex_destin(20, 43, 1)] = 1;
	state[getIndex_origin(21, 59, 1)] = 1;
	state[getIndex_destin(21, 45, 1)] = 1;
