...
int main(){
	...
	state[getIndex_origin(0, 42, 1)] = 1;
	state[getIndex_destin(0, 19, 1)] = 1;
	state[getIndex_origin(1, 19, 1)] = 1;
	...
	state[getIndex_origin(4, 32, 1)] = 1;
	state[getIndex_destin(4, 48, 1)] = 1;
	state[getIndex_origin(5, 23, 1)] = 1;
	state[getIndex_destin(5, 34, 1)] = 1;
	state[getIndex_origin(6, 36, 1)] = 1;
	state[getIndex_destin(6, 21, 1)] = 1;
	state[getIndex_origin(7, 29, 1)] = 1;
	state[getIndex_destin(7, 25, 1)] = 1;
	state[getIndex_origin(8, 34, 1)] = 1;
	state[getIndex_destin(8, 18, 1)] = 1;
	state[getIndex_origin(9, 43, 1)] = 1;
	state[getIndex_destin(9, 23, 1)] = 1;
	state[getIndex_origin(10, 48, 1)] = 1;
	state[getIndex_destin(10, 29, 1)] = 1;
	state[getIndex_origin(11, 31, 1)] = 1;
	state[getIndex_destin(11, 25, 1)] = 1;
	state[getIndex_origin(12, 22, 1)] = 1;
	state[getIndex_destin(12, 46, 1)] = 1;
	state[getIndex_origin(13, 39, 1)] = 1;
	state[getIndex_destin(13, 45, 1)] = 1;
	state[getIndex_origin(14, 20, 1)] = 1;
	state[getIndex_destin(14, 36, 1)] = 1;
	state[getIndex_origin(15, 17, 1)] = 1;
	state[getIndex_destin(15, 20, 1)] = 1;
