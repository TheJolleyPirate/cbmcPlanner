...
int main(){
	...
	state[getIndex_destin(0, 17, 1)] = 1;
	state[getIndex_origin(1, 35, 1)] = 1;
	state[getIndex_destin(1, 32, 1)] = 1;
	state[getIndex_origin(2, 28, 1)] = 1;
	...
	state[getIndex_origin(5, 24, 1)] = 1;
	state[getIndex_destin(5, 16, 1)] = 1;
	state[getIndex_origin(6, 17, 1)] = 1;
	state[getIndex_destin(6, 23, 1)] = 1;
	state[getIndex_origin(7, 30, 1)] = 1;
	state[getIndex_destin(7, 25, 1)] = 1;
	state[getIndex_origin(8, 16, 1)] = 1;
	state[getIndex_destin(8, 30, 1)] = 1;
	state[getIndex_origin(9, 18, 1)] = 1;
