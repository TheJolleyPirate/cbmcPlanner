...
//objects
//object translation:
//objectNames = {p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, f0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15, f16, f17, f18, f19, f20, f21, f22, f23, f24, f25, f26, f27, f28, f29, f30, f31, f32, f33, f34, f35, f36, f37, f38, f39};
...
int main(){
	...
	state[getIndex_above(20, 57, 1)] = 1;
	state[getIndex_above(20, 58, 1)] = 1;
	state[getIndex_above(20, 59, 1)] = 1;
	...
	state[getIndex_origin(0, 20, 1)] = 1;
	state[getIndex_destin(0, 41, 1)] = 1;
	state[getIndex_origin(1, 59, 1)] = 1;
	state[getIndex_destin(1, 24, 1)] = 1;
	state[getIndex_origin(2, 36, 1)] = 1;
	state[getIndex_destin(2, 43, 1)] = 1;
	state[getIndex_origin(3, 45, 1)] = 1;
	state[getIndex_destin(3, 50, 1)] = 1;
	state[getIndex_origin(4, 41, 1)] = 1;
	state[getIndex_destin(4, 31, 1)] = 1;
	state[getIndex_origin(5, 40, 1)] = 1;
	state[getIndex_destin(5, 48, 1)] = 1;
	state[getIndex_origin(6, 57, 1)] = 1;
	state[getIndex_destin(6, 47, 1)] = 1;
	state[getIndex_origin(7, 30, 1)] = 1;
	state[getIndex_destin(7, 41, 1)] = 1;
	state[getIndex_origin(8, 40, 1)] = 1;
	state[getIndex_destin(8, 38, 1)] = 1;
	state[getIndex_origin(9, 50, 1)] = 1;
	state[getIndex_destin(9, 43, 1)] = 1;
	state[getIndex_origin(10, 34, 1)] = 1;
	state[getIndex_destin(10, 41, 1)] = 1;
	state[getIndex_origin(11, 32, 1)] = 1;
	state[getIndex_destin(11, 35, 1)] = 1;
	state[getIndex_origin(12, 46, 1)] = 1;
	state[getIndex_destin(12, 33, 1)] = 1;
	state[getIndex_origin(13, 31, 1)] = 1;
	state[getIndex_destin(13, 37, 1)] = 1;
	state[getIndex_origin(14, 47, 1)] = 1;
	state[getIndex_destin(14, 24, 1)] = 1;
	state[getIndex_origin(15, 26, 1)] = 1;
	state[getIndex_destin(15, 48, 1)] = 1;
	state[getIndex_origin(16, 37, 1)] = 1;
	state[getIndex_destin(16, 25, 1)] = 1;
	state[getIndex_origin(17, 44, 1)] = 1;
	state[getIndex_destin(17, 53, 1)] = 1;
	state[getIndex_origin(18, 48, 1)] = 1;
	state[getIndex_destin(18, 22, 1)] = 1;
	state[getIndex_origin(19, 36, 1)] = 1;
	state[getIndex_destin(19, 21, 1)] = 1;
	state[getIndex_lift_at(20, 1)] = 1;
