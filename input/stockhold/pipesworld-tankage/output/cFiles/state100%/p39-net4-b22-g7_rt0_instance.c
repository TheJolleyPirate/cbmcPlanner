...
//objects
//object translation:
//objectNames = {lco, gasoleo, rat-a, oca1, oc1b, b10, b21, b17, b14, b4, b6, b15, b19, b20, b13, b8, b2, b11, b5, b0, b1, b18, b7, b12, b9, b3, b16, a1, a2, a3, a4, s12, s13, s34, s23, ta1-3-lco, ta1-2-lco, ta1-1-lco, ta1-2-gasoleo, ta1-1-gasoleo, ta1-1-rat-a, ta1-3-oca1, ta1-2-oca1, ta1-1-oca1, ta1-3-oc1b, ta1-2-oc1b, ta1-1-oc1b, ta2-3-lco, ta2-2-lco, ta2-1-lco, ta2-2-gasoleo, ta2-1-gasoleo, ta2-1-rat-a, ta2-3-oca1, ta2-2-oca1, ta2-1-oca1, ta2-3-oc1b, ta2-2-oc1b, ta2-1-oc1b, ta3-3-lco, ta3-2-lco, ta3-1-lco, ta3-2-gasoleo, ta3-1-gasoleo, ta3-2-rat-a, ta3-1-rat-a, ta3-3-oca1, ta3-2-oca1, ta3-1-oca1, ta3-3-oc1b, ta3-2-oc1b, ta3-1-oc1b, ta4-3-lco, ta4-2-lco, ta4-1-lco, ta4-2-gasoleo, ta4-1-gasoleo, ta4-1-rat-a, ta4-3-oca1, ta4-2-oca1, ta4-1-oca1, ta4-3-oc1b, ta4-2-oc1b, ta4-1-oc1b};
...
int main(){
	...
	while(1 == 1){
		...
		if((state[getIndex_on(8, 30, 0)] && state[getIndex_on(10, 27, 0)] && state[getIndex_on(11, 28, 0)] && state[getIndex_on(12, 29, 0)] && state[getIndex_on(15, 27, 0)] && state[getIndex_on(21, 30, 0)] && state[getIndex_on(22, 27, 0)] && state[getIndex_normal(31, 0)] && state[getIndex_normal(32, 0)] && state[getIndex_normal(33, 0)] && state[getIndex_normal(34, 0)])){
