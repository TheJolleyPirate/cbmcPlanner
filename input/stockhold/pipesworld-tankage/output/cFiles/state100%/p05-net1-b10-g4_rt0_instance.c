...
int main(){
	...
	while(1 == 1){
		...
		if((state[getIndex_on(8, 17, 0)] && state[getIndex_on(9, 16, 0)] && state[getIndex_on(10, 15, 0)] && state[getIndex_on(14, 15, 0)] && state[getIndex_normal(18, 0)] && state[getIndex_normal(19, 0)])){
