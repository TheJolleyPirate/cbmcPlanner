...
int main(){
	...
	while(1 == 1){
		...
		if((state[getIndex_on(6, 23, 0)] && state[getIndex_on(8, 24, 0)] && state[getIndex_on(9, 24, 0)] && state[getIndex_on(14, 25, 0)] && state[getIndex_on(17, 24, 0)] && state[getIndex_on(21, 25, 0)] && state[getIndex_normal(27, 0)] && state[getIndex_normal(28, 0)] && state[getIndex_normal(29, 0)])){
