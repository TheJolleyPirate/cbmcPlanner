...
int main(){
	...
	while(1 == 1){
		...
		if((state[getIndex_on(6, 28, 0)] && state[getIndex_on(7, 25, 0)] && state[getIndex_on(9, 27, 0)] && state[getIndex_on(14, 27, 0)] && state[getIndex_on(16, 27, 0)] && state[getIndex_normal(29, 0)] && state[getIndex_normal(30, 0)] && state[getIndex_normal(31, 0)] && state[getIndex_normal(32, 0)])){
