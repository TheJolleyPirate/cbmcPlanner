...
int main(){
	...
	while(1 == 1){
		...
		if((state[getIndex_on(6, 26, 0)] && state[getIndex_on(12, 24, 0)] && state[getIndex_on(13, 26, 0)] && state[getIndex_on(17, 25, 0)] && state[getIndex_on(18, 23, 0)] && state[getIndex_on(22, 25, 0)] && state[getIndex_normal(27, 0)] && state[getIndex_normal(28, 0)] && state[getIndex_normal(29, 0)] && state[getIndex_normal(30, 0)])){
