...
int main(){
	...
	while(1 == 1){
		...
		if((state[getIndex_on(7, 34, 0)] && state[getIndex_on(14, 32, 0)] && state[getIndex_on(16, 33, 0)] && state[getIndex_on(26, 35, 0)] && state[getIndex_normal(36, 0)] && state[getIndex_normal(37, 0)] && state[getIndex_normal(38, 0)] && state[getIndex_normal(39, 0)] && state[getIndex_normal(40, 0)])){
