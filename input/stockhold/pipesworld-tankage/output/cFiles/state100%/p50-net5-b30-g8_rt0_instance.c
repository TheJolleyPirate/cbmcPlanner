...
//objects
//object translation:
//objectNames = {lco, gasoleo, rat-a, oca1, oc1b, b10, b21, b17, b14, b27, b22, b4, b28, b6, b15, b19, b29, b20, b13, b8, b2, b11, b24, b5, b0, b1, b25, b18, b7, b12, b9, b3, b26, b23, b16, a1, a2, a3, a4, a5, s12, s13, s34, s23, s15, ta1-3-lco, ta1-2-lco, ta1-1-lco, ta1-4-gasoleo, ta1-3-gasoleo, ta1-2-gasoleo, ta1-1-gasoleo, ta1-4-rat-a, ta1-3-rat-a, ta1-2-rat-a, ta1-1-rat-a, ta1-3-oca1, ta1-2-oca1, ta1-1-oca1, ta1-2-oc1b, ta1-1-oc1b, ta2-3-lco, ta2-2-lco, ta2-1-lco, ta2-4-gasoleo, ta2-3-gasoleo, ta2-2-gasoleo, ta2-1-gasoleo, ta2-4-rat-a, ta2-3-rat-a, ta2-2-rat-a, ta2-1-rat-a, ta2-3-oca1, ta2-2-oca1, ta2-1-oca1, ta2-2-oc1b, ta2-1-oc1b, ta3-3-lco, ta3-2-lco, ta3-1-lco, ta3-4-gasoleo, ta3-3-gasoleo, ta3-2-gasoleo, ta3-1-gasoleo, ta3-4-rat-a, ta3-3-rat-a, ta3-2-rat-a, ta3-1-rat-a, ta3-3-oca1, ta3-2-oca1, ta3-1-oca1, ta3-2-oc1b, ta3-1-oc1b, ta4-3-lco, ta4-2-lco, ta4-1-lco, ta4-4-gasoleo, ta4-3-gasoleo, ta4-2-gasoleo, ta4-1-gasoleo, ta4-4-rat-a, ta4-3-rat-a, ta4-2-rat-a, ta4-1-rat-a, ta4-3-oca1, ta4-2-oca1, ta4-1-oca1, ta4-2-oc1b, ta4-1-oc1b, ta5-3-lco, ta5-2-lco, ta5-1-lco, ta5-4-gasoleo, ta5-3-gasoleo, ta5-2-gasoleo, ta5-1-gasoleo, ta5-4-rat-a, ta5-3-rat-a, ta5-2-rat-a, ta5-1-rat-a, ta5-3-oca1, ta5-2-oca1, ta5-1-oca1, ta5-2-oc1b, ta5-1-oc1b};
...
int main(){
	...
	while(1 == 1){
		...
		case 2:
			...
			if(index0 >= 0 && index0 < 5){
				...
				if(index1 >= 0 && index1 < 5){
					...
					if(index2 >= 0 && index2 < 5){
						index3 = nondet_Int();
						if(index3 >= 0 && index3 < 30){
							index4 = nondet_Int();
							if(index4 >= 0 && index4 < 30){
								index5 = nondet_Int();
								if(index5 >= 0 && index5 < 5){
									index6 = nondet_Int();
									if(index6 >= 0 && index6 < 80){
		...
		if((state[getIndex_on(7, 37, 0)] && state[getIndex_on(9, 38, 0)] && state[getIndex_on(13, 38, 0)] && state[getIndex_on(17, 36, 0)] && state[getIndex_on(21, 35, 0)] && state[getIndex_on(22, 38, 0)] && state[getIndex_on(27, 37, 0)] && state[getIndex_on(34, 35, 0)] && state[getIndex_normal(40, 0)] && state[getIndex_normal(41, 0)] && state[getIndex_normal(42, 0)] && state[getIndex_normal(43, 0)] && state[getIndex_normal(44, 0)])){
