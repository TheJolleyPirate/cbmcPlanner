...
int main(){
	...
	while(1 == 1){
		...
		if((state[getIndex_on(5, 21, 0)] && state[getIndex_on(6, 20, 0)] && state[getIndex_on(8, 19, 0)] && state[getIndex_on(9, 19, 0)] && state[getIndex_on(11, 20, 0)] && state[getIndex_on(12, 21, 0)] && state[getIndex_on(15, 20, 0)] && state[getIndex_on(18, 19, 0)] && state[getIndex_normal(22, 0)] && state[getIndex_normal(23, 0)])){
