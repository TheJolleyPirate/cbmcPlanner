...
int main(){
	...
	state[getIndex_origin(1, 53, 1)] = 1;
	state[getIndex_destin(1, 38, 1)] = 1;
	state[getIndex_origin(2, 34, 1)] = 1;
	state[getIndex_destin(2, 37, 1)] = 1;
	state[getIndex_origin(3, 19, 1)] = 1;
	state[getIndex_destin(3, 28, 1)] = 1;
	state[getIndex_origin(4, 31, 1)] = 1;
	state[getIndex_destin(4, 25, 1)] = 1;
	state[getIndex_origin(5, 18, 1)] = 1;
	state[getIndex_destin(5, 22, 1)] = 1;
	state[getIndex_origin(6, 35, 1)] = 1;
	state[getIndex_destin(6, 53, 1)] = 1;
	state[getIndex_origin(7, 36, 1)] = 1;
	state[getIndex_destin(7, 43, 1)] = 1;
	state[getIndex_origin(8, 46, 1)] = 1;
	state[getIndex_destin(8, 24, 1)] = 1;
	state[getIndex_origin(9, 48, 1)] = 1;
	state[getIndex_destin(9, 33, 1)] = 1;
	state[getIndex_origin(10, 28, 1)] = 1;
	state[getIndex_destin(10, 47, 1)] = 1;
	state[getIndex_origin(11, 46, 1)] = 1;
	state[getIndex_destin(11, 29, 1)] = 1;
	state[getIndex_origin(12, 36, 1)] = 1;
	state[getIndex_destin(12, 43, 1)] = 1;
	state[getIndex_origin(13, 25, 1)] = 1;
	state[getIndex_destin(13, 27, 1)] = 1;
	state[getIndex_origin(14, 53, 1)] = 1;
	state[getIndex_destin(14, 38, 1)] = 1;
	state[getIndex_origin(15, 20, 1)] = 1;
	state[getIndex_destin(15, 38, 1)] = 1;
	state[getIndex_origin(16, 23, 1)] = 1;
	state[getIndex_destin(16, 19, 1)] = 1;
	state[getIndex_origin(17, 38, 1)] = 1;
