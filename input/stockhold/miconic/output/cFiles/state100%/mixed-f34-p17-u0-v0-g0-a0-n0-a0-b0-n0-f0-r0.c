...
int main(){
	...
	state[getIndex_origin(0, 44, 1)] = 1;
	state[getIndex_destin(0, 49, 1)] = 1;
	state[getIndex_origin(1, 26, 1)] = 1;
	state[getIndex_destin(1, 34, 1)] = 1;
	state[getIndex_origin(2, 32, 1)] = 1;
	state[getIndex_destin(2, 20, 1)] = 1;
	state[getIndex_origin(3, 37, 1)] = 1;
	state[getIndex_destin(3, 31, 1)] = 1;
	state[getIndex_origin(4, 28, 1)] = 1;
	state[getIndex_destin(4, 36, 1)] = 1;
	state[getIndex_origin(5, 39, 1)] = 1;
	state[getIndex_destin(5, 48, 1)] = 1;
	state[getIndex_origin(6, 37, 1)] = 1;
	state[getIndex_destin(6, 36, 1)] = 1;
	state[getIndex_origin(7, 46, 1)] = 1;
	state[getIndex_destin(7, 39, 1)] = 1;
	state[getIndex_origin(8, 45, 1)] = 1;
	state[getIndex_destin(8, 47, 1)] = 1;
	state[getIndex_origin(9, 23, 1)] = 1;
	state[getIndex_destin(9, 31, 1)] = 1;
	state[getIndex_origin(10, 18, 1)] = 1;
	state[getIndex_destin(10, 25, 1)] = 1;
	state[getIndex_origin(11, 36, 1)] = 1;
	state[getIndex_destin(11, 22, 1)] = 1;
	state[getIndex_origin(12, 31, 1)] = 1;
	state[getIndex_destin(12, 39, 1)] = 1;
	state[getIndex_origin(13, 25, 1)] = 1;
	state[getIndex_destin(13, 38, 1)] = 1;
	state[getIndex_origin(14, 48, 1)] = 1;
	state[getIndex_destin(14, 28, 1)] = 1;
	state[getIndex_origin(15, 34, 1)] = 1;
	state[getIndex_destin(15, 49, 1)] = 1;
	state[getIndex_origin(16, 27, 1)] = 1;
	state[getIndex_destin(16, 17, 1)] = 1;
