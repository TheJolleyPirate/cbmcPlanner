...
int main(){
	...
	state[getIndex_destin(1, 18, 1)] = 1;
	state[getIndex_origin(2, 20, 1)] = 1;
	state[getIndex_destin(2, 30, 1)] = 1;
	state[getIndex_origin(3, 22, 1)] = 1;
	state[getIndex_destin(3, 43, 1)] = 1;
	state[getIndex_origin(4, 45, 1)] = 1;
	state[getIndex_destin(4, 33, 1)] = 1;
	state[getIndex_origin(5, 16, 1)] = 1;
	state[getIndex_destin(5, 22, 1)] = 1;
	state[getIndex_origin(6, 45, 1)] = 1;
	state[getIndex_destin(6, 38, 1)] = 1;
	state[getIndex_origin(7, 35, 1)] = 1;
	state[getIndex_destin(7, 46, 1)] = 1;
	state[getIndex_origin(8, 45, 1)] = 1;
	state[getIndex_destin(8, 44, 1)] = 1;
	state[getIndex_origin(9, 41, 1)] = 1;
	state[getIndex_destin(9, 23, 1)] = 1;
	state[getIndex_origin(10, 17, 1)] = 1;
	state[getIndex_destin(10, 42, 1)] = 1;
	state[getIndex_origin(11, 33, 1)] = 1;
	state[getIndex_destin(11, 28, 1)] = 1;
	state[getIndex_origin(12, 42, 1)] = 1;
	state[getIndex_destin(12, 27, 1)] = 1;
	state[getIndex_origin(13, 24, 1)] = 1;
	state[getIndex_destin(13, 39, 1)] = 1;
	state[getIndex_origin(14, 39, 1)] = 1;
	state[getIndex_destin(14, 42, 1)] = 1;
	state[getIndex_origin(15, 30, 1)] = 1;
