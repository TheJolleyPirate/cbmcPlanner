...
int main(){
	...
	state[getIndex_origin(0, 37, 1)] = 1;
	state[getIndex_destin(0, 53, 1)] = 1;
	state[getIndex_origin(1, 36, 1)] = 1;
	state[getIndex_destin(1, 44, 1)] = 1;
	state[getIndex_origin(2, 62, 1)] = 1;
	state[getIndex_destin(2, 48, 1)] = 1;
	state[getIndex_origin(3, 60, 1)] = 1;
	state[getIndex_destin(3, 65, 1)] = 1;
	state[getIndex_origin(4, 43, 1)] = 1;
	state[getIndex_destin(4, 59, 1)] = 1;
	state[getIndex_origin(5, 30, 1)] = 1;
	state[getIndex_destin(5, 32, 1)] = 1;
	state[getIndex_origin(6, 39, 1)] = 1;
	state[getIndex_destin(6, 52, 1)] = 1;
	state[getIndex_origin(7, 65, 1)] = 1;
	state[getIndex_destin(7, 48, 1)] = 1;
	state[getIndex_origin(8, 63, 1)] = 1;
	state[getIndex_destin(8, 38, 1)] = 1;
	state[getIndex_origin(9, 27, 1)] = 1;
	state[getIndex_destin(9, 65, 1)] = 1;
	state[getIndex_origin(10, 63, 1)] = 1;
	state[getIndex_destin(10, 60, 1)] = 1;
	state[getIndex_origin(11, 39, 1)] = 1;
	state[getIndex_destin(11, 26, 1)] = 1;
	state[getIndex_origin(12, 40, 1)] = 1;
	state[getIndex_destin(12, 49, 1)] = 1;
	state[getIndex_origin(13, 42, 1)] = 1;
	state[getIndex_destin(13, 57, 1)] = 1;
	state[getIndex_origin(14, 57, 1)] = 1;
	state[getIndex_destin(14, 56, 1)] = 1;
	state[getIndex_origin(15, 28, 1)] = 1;
	state[getIndex_destin(15, 49, 1)] = 1;
	state[getIndex_origin(16, 43, 1)] = 1;
	state[getIndex_destin(16, 42, 1)] = 1;
	state[getIndex_origin(17, 27, 1)] = 1;
	state[getIndex_destin(17, 59, 1)] = 1;
	state[getIndex_origin(18, 45, 1)] = 1;
	state[getIndex_destin(18, 42, 1)] = 1;
	state[getIndex_origin(19, 34, 1)] = 1;
	state[getIndex_destin(19, 22, 1)] = 1;
	state[getIndex_origin(20, 55, 1)] = 1;
	state[getIndex_destin(20, 42, 1)] = 1;
	state[getIndex_origin(21, 52, 1)] = 1;
