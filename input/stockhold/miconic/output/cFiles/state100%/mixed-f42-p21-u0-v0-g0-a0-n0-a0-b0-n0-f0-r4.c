...
int main(){
	...
	state[getIndex_origin(0, 54, 1)] = 1;
	state[getIndex_destin(0, 48, 1)] = 1;
	state[getIndex_origin(1, 33, 1)] = 1;
	state[getIndex_destin(1, 59, 1)] = 1;
	state[getIndex_origin(2, 21, 1)] = 1;
	state[getIndex_destin(2, 55, 1)] = 1;
	state[getIndex_origin(3, 56, 1)] = 1;
	state[getIndex_destin(3, 36, 1)] = 1;
	state[getIndex_origin(4, 24, 1)] = 1;
	state[getIndex_destin(4, 53, 1)] = 1;
	state[getIndex_origin(5, 29, 1)] = 1;
	state[getIndex_destin(5, 46, 1)] = 1;
	state[getIndex_origin(6, 29, 1)] = 1;
	state[getIndex_destin(6, 36, 1)] = 1;
	state[getIndex_origin(7, 27, 1)] = 1;
	state[getIndex_destin(7, 30, 1)] = 1;
	state[getIndex_origin(8, 59, 1)] = 1;
	state[getIndex_destin(8, 40, 1)] = 1;
	state[getIndex_origin(9, 22, 1)] = 1;
	state[getIndex_destin(9, 58, 1)] = 1;
	state[getIndex_origin(10, 21, 1)] = 1;
	state[getIndex_destin(10, 52, 1)] = 1;
	state[getIndex_origin(11, 31, 1)] = 1;
	state[getIndex_destin(11, 57, 1)] = 1;
	state[getIndex_origin(12, 36, 1)] = 1;
	state[getIndex_destin(12, 55, 1)] = 1;
	state[getIndex_origin(13, 48, 1)] = 1;
	state[getIndex_destin(13, 34, 1)] = 1;
	state[getIndex_origin(14, 41, 1)] = 1;
	state[getIndex_destin(14, 39, 1)] = 1;
	state[getIndex_origin(15, 24, 1)] = 1;
	state[getIndex_destin(15, 26, 1)] = 1;
	state[getIndex_origin(16, 51, 1)] = 1;
	state[getIndex_destin(16, 62, 1)] = 1;
	state[getIndex_origin(17, 24, 1)] = 1;
	state[getIndex_destin(17, 50, 1)] = 1;
	state[getIndex_origin(18, 53, 1)] = 1;
	state[getIndex_destin(18, 57, 1)] = 1;
	state[getIndex_origin(19, 23, 1)] = 1;
	state[getIndex_destin(19, 54, 1)] = 1;
	state[getIndex_origin(20, 47, 1)] = 1;
	state[getIndex_destin(20, 29, 1)] = 1;
