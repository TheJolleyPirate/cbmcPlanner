...
int main(){
	...
	state[getIndex_origin(9, 19, 1)] = 1;
	state[getIndex_destin(9, 29, 1)] = 1;
	state[getIndex_origin(10, 23, 1)] = 1;
	...
	state[getIndex_destin(12, 29, 1)] = 1;
	state[getIndex_origin(13, 34, 1)] = 1;
	state[getIndex_destin(13, 41, 1)] = 1;
