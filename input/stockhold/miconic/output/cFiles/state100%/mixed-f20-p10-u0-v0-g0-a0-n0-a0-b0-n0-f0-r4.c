...
int main(){
	...
	state[getIndex_origin(0, 25, 1)] = 1;
	...
	state[getIndex_destin(3, 15, 1)] = 1;
	...
	state[getIndex_origin(7, 28, 1)] = 1;
	state[getIndex_destin(7, 23, 1)] = 1;
	state[getIndex_origin(8, 10, 1)] = 1;
	state[getIndex_destin(8, 23, 1)] = 1;
	state[getIndex_origin(9, 13, 1)] = 1;
