...
int main(){
	...
	state[getIndex_origin(0, 40, 1)] = 1;
	state[getIndex_destin(0, 21, 1)] = 1;
	state[getIndex_origin(1, 39, 1)] = 1;
	state[getIndex_destin(1, 44, 1)] = 1;
	state[getIndex_origin(2, 16, 1)] = 1;
	state[getIndex_destin(2, 39, 1)] = 1;
	...
	state[getIndex_destin(7, 20, 1)] = 1;
	state[getIndex_origin(8, 18, 1)] = 1;
	state[getIndex_destin(8, 38, 1)] = 1;
	state[getIndex_origin(9, 39, 1)] = 1;
	state[getIndex_destin(9, 30, 1)] = 1;
	state[getIndex_origin(10, 29, 1)] = 1;
	state[getIndex_destin(10, 36, 1)] = 1;
	state[getIndex_origin(11, 47, 1)] = 1;
	state[getIndex_destin(11, 34, 1)] = 1;
	state[getIndex_origin(12, 29, 1)] = 1;
	state[getIndex_destin(12, 27, 1)] = 1;
	state[getIndex_origin(13, 33, 1)] = 1;
	state[getIndex_destin(13, 19, 1)] = 1;
	state[getIndex_origin(14, 44, 1)] = 1;
	state[getIndex_destin(14, 46, 1)] = 1;
