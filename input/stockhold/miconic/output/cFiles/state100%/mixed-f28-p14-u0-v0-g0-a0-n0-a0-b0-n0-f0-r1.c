...
int main(){
	...
	state[getIndex_destin(0, 15, 1)] = 1;
	state[getIndex_origin(1, 21, 1)] = 1;
	state[getIndex_destin(1, 38, 1)] = 1;
	state[getIndex_origin(2, 30, 1)] = 1;
	state[getIndex_destin(2, 21, 1)] = 1;
	state[getIndex_origin(3, 27, 1)] = 1;
	state[getIndex_destin(3, 16, 1)] = 1;
	state[getIndex_origin(4, 23, 1)] = 1;
	state[getIndex_destin(4, 33, 1)] = 1;
	state[getIndex_origin(5, 34, 1)] = 1;
	state[getIndex_destin(5, 18, 1)] = 1;
	state[getIndex_origin(6, 15, 1)] = 1;
	state[getIndex_destin(6, 33, 1)] = 1;
	...
	state[getIndex_destin(10, 31, 1)] = 1;
	state[getIndex_origin(11, 30, 1)] = 1;
	state[getIndex_destin(11, 37, 1)] = 1;
	state[getIndex_origin(12, 28, 1)] = 1;
	state[getIndex_destin(12, 23, 1)] = 1;
	state[getIndex_origin(13, 17, 1)] = 1;
