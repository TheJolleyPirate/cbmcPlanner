...
//objects
//object translation:
//objectNames = {p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, f0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15, f16, f17, f18, f19, f20, f21, f22, f23, f24, f25, f26, f27, f28, f29, f30, f31};
...
int main(){
	...
	state[getIndex_above(16, 45, 1)] = 1;
	state[getIndex_above(16, 46, 1)] = 1;
	state[getIndex_above(16, 47, 1)] = 1;
	...
	state[getIndex_origin(0, 17, 1)] = 1;
	state[getIndex_destin(0, 31, 1)] = 1;
	state[getIndex_origin(1, 30, 1)] = 1;
	state[getIndex_destin(1, 35, 1)] = 1;
	state[getIndex_origin(2, 35, 1)] = 1;
	state[getIndex_destin(2, 28, 1)] = 1;
	state[getIndex_origin(3, 37, 1)] = 1;
	state[getIndex_destin(3, 16, 1)] = 1;
	state[getIndex_origin(4, 35, 1)] = 1;
	state[getIndex_destin(4, 24, 1)] = 1;
	state[getIndex_origin(5, 39, 1)] = 1;
	state[getIndex_destin(5, 22, 1)] = 1;
	state[getIndex_origin(6, 16, 1)] = 1;
	state[getIndex_destin(6, 30, 1)] = 1;
	state[getIndex_origin(7, 26, 1)] = 1;
	state[getIndex_destin(7, 43, 1)] = 1;
	state[getIndex_origin(8, 44, 1)] = 1;
	state[getIndex_destin(8, 39, 1)] = 1;
	state[getIndex_origin(9, 22, 1)] = 1;
	state[getIndex_destin(9, 20, 1)] = 1;
	state[getIndex_origin(10, 40, 1)] = 1;
	state[getIndex_destin(10, 37, 1)] = 1;
	state[getIndex_origin(11, 16, 1)] = 1;
	state[getIndex_destin(11, 35, 1)] = 1;
	state[getIndex_origin(12, 40, 1)] = 1;
	state[getIndex_destin(12, 38, 1)] = 1;
	state[getIndex_origin(13, 46, 1)] = 1;
	state[getIndex_destin(13, 34, 1)] = 1;
	state[getIndex_origin(14, 29, 1)] = 1;
	state[getIndex_destin(14, 41, 1)] = 1;
	state[getIndex_origin(15, 39, 1)] = 1;
	state[getIndex_destin(15, 30, 1)] = 1;
	state[getIndex_lift_at(16, 1)] = 1;
	...
	while(1 == 1){
		...
		case 1:
 			index0 = nondet_Int();
			if(index0 >= 0 && index0 < 48){
				index1 = nondet_Int();
				if(index1 >= 0 && index1 < 48){
