...
int main(){
	...
	state[getIndex_origin(0, 28, 1)] = 1;
	state[getIndex_destin(0, 15, 1)] = 1;
	state[getIndex_origin(1, 19, 1)] = 1;
	state[getIndex_destin(1, 27, 1)] = 1;
	...
	state[getIndex_destin(5, 38, 1)] = 1;
	...
	state[getIndex_destin(10, 23, 1)] = 1;
	...
	state[getIndex_origin(13, 23, 1)] = 1;
