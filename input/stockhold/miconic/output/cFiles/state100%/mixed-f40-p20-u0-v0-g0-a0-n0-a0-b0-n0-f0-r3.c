...
int main(){
	...
	state[getIndex_origin(0, 53, 1)] = 1;
	state[getIndex_destin(0, 35, 1)] = 1;
	state[getIndex_origin(1, 26, 1)] = 1;
	state[getIndex_destin(1, 39, 1)] = 1;
	state[getIndex_origin(2, 39, 1)] = 1;
	state[getIndex_destin(2, 48, 1)] = 1;
	state[getIndex_origin(3, 25, 1)] = 1;
	state[getIndex_destin(3, 28, 1)] = 1;
	state[getIndex_origin(4, 31, 1)] = 1;
	state[getIndex_destin(4, 52, 1)] = 1;
	state[getIndex_origin(5, 51, 1)] = 1;
	state[getIndex_destin(5, 34, 1)] = 1;
	state[getIndex_origin(6, 44, 1)] = 1;
	state[getIndex_destin(6, 26, 1)] = 1;
	state[getIndex_origin(7, 22, 1)] = 1;
	state[getIndex_destin(7, 47, 1)] = 1;
	state[getIndex_origin(8, 48, 1)] = 1;
	state[getIndex_destin(8, 43, 1)] = 1;
	state[getIndex_origin(9, 50, 1)] = 1;
	state[getIndex_destin(9, 48, 1)] = 1;
	state[getIndex_origin(10, 28, 1)] = 1;
	state[getIndex_destin(10, 33, 1)] = 1;
	state[getIndex_origin(11, 52, 1)] = 1;
	state[getIndex_destin(11, 39, 1)] = 1;
	state[getIndex_origin(12, 28, 1)] = 1;
	state[getIndex_destin(12, 42, 1)] = 1;
	state[getIndex_origin(13, 58, 1)] = 1;
	state[getIndex_destin(13, 22, 1)] = 1;
	state[getIndex_origin(14, 57, 1)] = 1;
	state[getIndex_destin(14, 53, 1)] = 1;
	state[getIndex_origin(15, 35, 1)] = 1;
	state[getIndex_destin(15, 50, 1)] = 1;
	state[getIndex_origin(16, 28, 1)] = 1;
	state[getIndex_destin(16, 33, 1)] = 1;
	state[getIndex_origin(17, 22, 1)] = 1;
	state[getIndex_destin(17, 40, 1)] = 1;
	state[getIndex_origin(18, 21, 1)] = 1;
	state[getIndex_destin(18, 27, 1)] = 1;
	state[getIndex_origin(19, 40, 1)] = 1;
	state[getIndex_destin(19, 33, 1)] = 1;
