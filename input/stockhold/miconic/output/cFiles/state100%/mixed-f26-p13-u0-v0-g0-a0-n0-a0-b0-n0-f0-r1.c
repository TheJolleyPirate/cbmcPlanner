...
int main(){
	...
	state[getIndex_origin(0, 33, 1)] = 1;
	state[getIndex_destin(0, 14, 1)] = 1;
	...
	state[getIndex_destin(3, 35, 1)] = 1;
	state[getIndex_origin(4, 18, 1)] = 1;
	state[getIndex_destin(4, 16, 1)] = 1;
	state[getIndex_origin(5, 25, 1)] = 1;
	state[getIndex_destin(5, 37, 1)] = 1;
	state[getIndex_origin(6, 38, 1)] = 1;
	state[getIndex_destin(6, 14, 1)] = 1;
	state[getIndex_origin(7, 21, 1)] = 1;
	state[getIndex_destin(7, 34, 1)] = 1;
	state[getIndex_origin(8, 29, 1)] = 1;
	state[getIndex_destin(8, 35, 1)] = 1;
	state[getIndex_origin(9, 35, 1)] = 1;
	state[getIndex_destin(9, 16, 1)] = 1;
	...
	state[getIndex_origin(12, 35, 1)] = 1;
	state[getIndex_destin(12, 22, 1)] = 1;
