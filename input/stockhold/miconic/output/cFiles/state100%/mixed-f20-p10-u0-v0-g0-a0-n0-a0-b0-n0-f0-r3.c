...
//objects
//object translation:
//objectNames = {p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, f0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15, f16, f17, f18, f19};
...
int main(){
	...
	state[getIndex_above(10, 27, 1)] = 1;
	state[getIndex_above(10, 28, 1)] = 1;
	state[getIndex_above(10, 29, 1)] = 1;
	...
	state[getIndex_origin(3, 15, 1)] = 1;
	state[getIndex_destin(3, 18, 1)] = 1;
	...
	while(1 == 1){
		...
		if((state[getIndex_served(0, 0)] && state[getIndex_served(1, 0)] && state[getIndex_served(2, 0)] && state[getIndex_served(3, 0)] && state[getIndex_served(4, 0)] && state[getIndex_served(5, 0)] && state[getIndex_served(6, 0)] && state[getIndex_served(7, 0)] && state[getIndex_served(8, 0)] && state[getIndex_served(9, 0)])){
