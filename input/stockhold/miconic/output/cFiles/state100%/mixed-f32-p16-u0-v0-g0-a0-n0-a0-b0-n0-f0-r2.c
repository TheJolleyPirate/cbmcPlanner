...
int main(){
	...
	state[getIndex_origin(0, 27, 1)] = 1;
	state[getIndex_destin(0, 32, 1)] = 1;
	state[getIndex_origin(1, 20, 1)] = 1;
	state[getIndex_destin(1, 26, 1)] = 1;
	state[getIndex_origin(2, 41, 1)] = 1;
	state[getIndex_destin(2, 30, 1)] = 1;
	state[getIndex_origin(3, 38, 1)] = 1;
	state[getIndex_destin(3, 30, 1)] = 1;
	state[getIndex_origin(4, 31, 1)] = 1;
	state[getIndex_destin(4, 39, 1)] = 1;
	state[getIndex_origin(5, 26, 1)] = 1;
	state[getIndex_destin(5, 43, 1)] = 1;
	state[getIndex_origin(6, 47, 1)] = 1;
	state[getIndex_destin(6, 34, 1)] = 1;
	state[getIndex_origin(7, 18, 1)] = 1;
	state[getIndex_destin(7, 46, 1)] = 1;
	state[getIndex_origin(8, 25, 1)] = 1;
	state[getIndex_destin(8, 47, 1)] = 1;
	state[getIndex_origin(9, 44, 1)] = 1;
	state[getIndex_destin(9, 24, 1)] = 1;
	state[getIndex_origin(10, 25, 1)] = 1;
	state[getIndex_destin(10, 16, 1)] = 1;
	state[getIndex_origin(11, 40, 1)] = 1;
	state[getIndex_destin(11, 32, 1)] = 1;
	state[getIndex_origin(12, 17, 1)] = 1;
	state[getIndex_destin(12, 35, 1)] = 1;
	state[getIndex_origin(13, 38, 1)] = 1;
	state[getIndex_destin(13, 46, 1)] = 1;
	state[getIndex_origin(14, 23, 1)] = 1;
	state[getIndex_destin(14, 19, 1)] = 1;
	state[getIndex_origin(15, 30, 1)] = 1;
	state[getIndex_destin(15, 35, 1)] = 1;
