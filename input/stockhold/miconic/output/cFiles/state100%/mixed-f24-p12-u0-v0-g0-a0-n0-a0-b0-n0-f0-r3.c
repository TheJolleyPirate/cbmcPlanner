...
int main(){
	...
	state[getIndex_origin(1, 18, 1)] = 1;
	state[getIndex_destin(1, 31, 1)] = 1;
	state[getIndex_origin(2, 15, 1)] = 1;
	state[getIndex_destin(2, 24, 1)] = 1;
	state[getIndex_origin(3, 17, 1)] = 1;
	state[getIndex_destin(3, 12, 1)] = 1;
	state[getIndex_origin(4, 15, 1)] = 1;
	state[getIndex_destin(4, 20, 1)] = 1;
	state[getIndex_origin(5, 19, 1)] = 1;
	state[getIndex_destin(5, 18, 1)] = 1;
	state[getIndex_origin(6, 28, 1)] = 1;
	state[getIndex_destin(6, 18, 1)] = 1;
	state[getIndex_origin(7, 22, 1)] = 1;
	state[getIndex_destin(7, 31, 1)] = 1;
	state[getIndex_origin(8, 32, 1)] = 1;
	state[getIndex_destin(8, 19, 1)] = 1;
	state[getIndex_origin(9, 26, 1)] = 1;
	state[getIndex_destin(9, 24, 1)] = 1;
	state[getIndex_origin(10, 28, 1)] = 1;
	state[getIndex_destin(10, 17, 1)] = 1;
	state[getIndex_origin(11, 12, 1)] = 1;
