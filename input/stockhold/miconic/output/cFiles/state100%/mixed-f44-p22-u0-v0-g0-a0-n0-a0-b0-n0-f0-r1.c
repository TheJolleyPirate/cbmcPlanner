...
int main(){
	...
	state[getIndex_destin(1, 38, 1)] = 1;
	state[getIndex_origin(2, 26, 1)] = 1;
	state[getIndex_destin(2, 61, 1)] = 1;
	state[getIndex_origin(3, 35, 1)] = 1;
	state[getIndex_destin(3, 40, 1)] = 1;
	state[getIndex_origin(4, 39, 1)] = 1;
	state[getIndex_destin(4, 29, 1)] = 1;
	state[getIndex_origin(5, 42, 1)] = 1;
	state[getIndex_destin(5, 46, 1)] = 1;
	state[getIndex_origin(6, 59, 1)] = 1;
	state[getIndex_destin(6, 61, 1)] = 1;
	state[getIndex_origin(7, 48, 1)] = 1;
	state[getIndex_destin(7, 59, 1)] = 1;
	state[getIndex_origin(8, 58, 1)] = 1;
	state[getIndex_destin(8, 24, 1)] = 1;
	state[getIndex_origin(9, 36, 1)] = 1;
	state[getIndex_destin(9, 61, 1)] = 1;
	state[getIndex_origin(10, 60, 1)] = 1;
	state[getIndex_destin(10, 35, 1)] = 1;
	state[getIndex_origin(11, 54, 1)] = 1;
	state[getIndex_destin(11, 33, 1)] = 1;
	state[getIndex_origin(12, 36, 1)] = 1;
	state[getIndex_destin(12, 27, 1)] = 1;
	state[getIndex_origin(13, 65, 1)] = 1;
	state[getIndex_destin(13, 27, 1)] = 1;
	state[getIndex_origin(14, 53, 1)] = 1;
	state[getIndex_destin(14, 42, 1)] = 1;
	state[getIndex_origin(15, 48, 1)] = 1;
	state[getIndex_destin(15, 54, 1)] = 1;
	state[getIndex_origin(16, 63, 1)] = 1;
	state[getIndex_destin(16, 59, 1)] = 1;
	state[getIndex_origin(17, 46, 1)] = 1;
	state[getIndex_destin(17, 23, 1)] = 1;
	state[getIndex_origin(18, 54, 1)] = 1;
	state[getIndex_destin(18, 36, 1)] = 1;
	state[getIndex_origin(19, 62, 1)] = 1;
	state[getIndex_destin(19, 47, 1)] = 1;
	state[getIndex_origin(20, 43, 1)] = 1;
	state[getIndex_destin(20, 38, 1)] = 1;
	state[getIndex_origin(21, 27, 1)] = 1;
	state[getIndex_destin(21, 56, 1)] = 1;
