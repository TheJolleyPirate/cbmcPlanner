...
//objects
//object translation:
//objectNames = {p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, f0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15, f16, f17, f18, f19, f20, f21, f22, f23, f24, f25, f26, f27};
...
int main(){
	...
	state[getIndex_above(14, 39, 1)] = 1;
	state[getIndex_above(14, 40, 1)] = 1;
	state[getIndex_above(14, 41, 1)] = 1;
	...
	state[getIndex_destin(1, 41, 1)] = 1;
	...
	state[getIndex_destin(4, 26, 1)] = 1;
	state[getIndex_origin(5, 33, 1)] = 1;
	state[getIndex_destin(5, 40, 1)] = 1;
	state[getIndex_origin(6, 14, 1)] = 1;
	state[getIndex_destin(6, 36, 1)] = 1;
	state[getIndex_origin(7, 36, 1)] = 1;
	state[getIndex_destin(7, 29, 1)] = 1;
	state[getIndex_origin(8, 34, 1)] = 1;
	state[getIndex_destin(8, 29, 1)] = 1;
	state[getIndex_origin(9, 32, 1)] = 1;
	state[getIndex_destin(9, 30, 1)] = 1;
	state[getIndex_origin(10, 22, 1)] = 1;
	state[getIndex_destin(10, 35, 1)] = 1;
	state[getIndex_origin(11, 22, 1)] = 1;
	state[getIndex_destin(11, 41, 1)] = 1;
	state[getIndex_origin(12, 26, 1)] = 1;
	state[getIndex_destin(12, 24, 1)] = 1;
	state[getIndex_origin(13, 32, 1)] = 1;
	state[getIndex_destin(13, 28, 1)] = 1;
	state[getIndex_lift_at(14, 1)] = 1;
	...
	while(1 == 1){
		...
		case 1:
 			index0 = nondet_Int();
			if(index0 >= 0 && index0 < 42){
				index1 = nondet_Int();
				if(index1 >= 0 && index1 < 42){
