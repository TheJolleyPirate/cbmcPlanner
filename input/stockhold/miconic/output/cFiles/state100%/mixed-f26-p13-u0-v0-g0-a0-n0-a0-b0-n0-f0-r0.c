...
int main(){
	...
	state[getIndex_origin(0, 26, 1)] = 1;
	state[getIndex_destin(0, 35, 1)] = 1;
	state[getIndex_origin(1, 24, 1)] = 1;
	state[getIndex_destin(1, 30, 1)] = 1;
	state[getIndex_origin(2, 14, 1)] = 1;
	state[getIndex_destin(2, 25, 1)] = 1;
	state[getIndex_origin(3, 29, 1)] = 1;
	state[getIndex_destin(3, 14, 1)] = 1;
	state[getIndex_origin(4, 20, 1)] = 1;
	state[getIndex_destin(4, 15, 1)] = 1;
	...
	state[getIndex_destin(7, 35, 1)] = 1;
	state[getIndex_origin(8, 23, 1)] = 1;
	state[getIndex_destin(8, 37, 1)] = 1;
	state[getIndex_origin(9, 20, 1)] = 1;
	state[getIndex_destin(9, 21, 1)] = 1;
	state[getIndex_origin(10, 16, 1)] = 1;
	state[getIndex_destin(10, 29, 1)] = 1;
	state[getIndex_origin(11, 31, 1)] = 1;
	state[getIndex_destin(11, 15, 1)] = 1;
	state[getIndex_origin(12, 16, 1)] = 1;
	state[getIndex_destin(12, 36, 1)] = 1;
