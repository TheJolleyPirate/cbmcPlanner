...
int main(){
	...
	state[getIndex_origin(0, 58, 1)] = 1;
	state[getIndex_destin(0, 57, 1)] = 1;
	state[getIndex_origin(1, 49, 1)] = 1;
	state[getIndex_destin(1, 51, 1)] = 1;
	state[getIndex_origin(2, 48, 1)] = 1;
	state[getIndex_destin(2, 51, 1)] = 1;
	state[getIndex_origin(3, 23, 1)] = 1;
	state[getIndex_destin(3, 53, 1)] = 1;
	state[getIndex_origin(4, 22, 1)] = 1;
	state[getIndex_destin(4, 42, 1)] = 1;
	state[getIndex_origin(5, 23, 1)] = 1;
	state[getIndex_destin(5, 44, 1)] = 1;
	state[getIndex_origin(6, 34, 1)] = 1;
	state[getIndex_destin(6, 41, 1)] = 1;
	state[getIndex_origin(7, 45, 1)] = 1;
	state[getIndex_destin(7, 57, 1)] = 1;
	state[getIndex_origin(8, 22, 1)] = 1;
	state[getIndex_destin(8, 54, 1)] = 1;
	state[getIndex_origin(9, 51, 1)] = 1;
	state[getIndex_destin(9, 28, 1)] = 1;
	state[getIndex_origin(10, 47, 1)] = 1;
	state[getIndex_destin(10, 61, 1)] = 1;
	state[getIndex_origin(11, 39, 1)] = 1;
	state[getIndex_destin(11, 56, 1)] = 1;
	state[getIndex_origin(12, 36, 1)] = 1;
	state[getIndex_destin(12, 47, 1)] = 1;
	state[getIndex_origin(13, 21, 1)] = 1;
	state[getIndex_destin(13, 24, 1)] = 1;
	state[getIndex_origin(14, 46, 1)] = 1;
	state[getIndex_destin(14, 45, 1)] = 1;
	state[getIndex_origin(15, 60, 1)] = 1;
	state[getIndex_destin(15, 40, 1)] = 1;
	state[getIndex_origin(16, 31, 1)] = 1;
	state[getIndex_destin(16, 46, 1)] = 1;
	state[getIndex_origin(17, 24, 1)] = 1;
	state[getIndex_destin(17, 62, 1)] = 1;
	state[getIndex_origin(18, 48, 1)] = 1;
	state[getIndex_destin(18, 56, 1)] = 1;
	state[getIndex_origin(19, 61, 1)] = 1;
	state[getIndex_destin(19, 27, 1)] = 1;
	state[getIndex_origin(20, 56, 1)] = 1;
	state[getIndex_destin(20, 41, 1)] = 1;
