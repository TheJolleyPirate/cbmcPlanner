...
int main(){
	...
	state[getIndex_origin(12, 52, 1)] = 1;
	state[getIndex_destin(12, 51, 1)] = 1;
	state[getIndex_origin(13, 20, 1)] = 1;
	state[getIndex_destin(13, 26, 1)] = 1;
	state[getIndex_origin(14, 51, 1)] = 1;
	state[getIndex_destin(14, 37, 1)] = 1;
	state[getIndex_origin(15, 22, 1)] = 1;
	state[getIndex_destin(15, 42, 1)] = 1;
	state[getIndex_origin(16, 49, 1)] = 1;
	state[getIndex_destin(16, 26, 1)] = 1;
	state[getIndex_origin(17, 42, 1)] = 1;
	state[getIndex_destin(17, 44, 1)] = 1;
	state[getIndex_origin(18, 29, 1)] = 1;
	state[getIndex_destin(18, 19, 1)] = 1;
