...
int main(){
	...
	state[getIndex_origin(0, 23, 1)] = 1;
	state[getIndex_destin(0, 20, 1)] = 1;
	state[getIndex_origin(1, 24, 1)] = 1;
	state[getIndex_destin(1, 22, 1)] = 1;
	state[getIndex_origin(2, 53, 1)] = 1;
	state[getIndex_destin(2, 34, 1)] = 1;
	state[getIndex_origin(3, 50, 1)] = 1;
	state[getIndex_destin(3, 34, 1)] = 1;
	state[getIndex_origin(4, 59, 1)] = 1;
	state[getIndex_destin(4, 30, 1)] = 1;
	state[getIndex_origin(5, 23, 1)] = 1;
	state[getIndex_destin(5, 51, 1)] = 1;
	state[getIndex_origin(6, 22, 1)] = 1;
	state[getIndex_destin(6, 46, 1)] = 1;
	state[getIndex_origin(7, 34, 1)] = 1;
	state[getIndex_destin(7, 45, 1)] = 1;
	state[getIndex_origin(8, 35, 1)] = 1;
	state[getIndex_destin(8, 24, 1)] = 1;
	state[getIndex_origin(9, 20, 1)] = 1;
	state[getIndex_destin(9, 45, 1)] = 1;
	state[getIndex_origin(10, 28, 1)] = 1;
	state[getIndex_destin(10, 44, 1)] = 1;
	state[getIndex_origin(11, 53, 1)] = 1;
	state[getIndex_destin(11, 31, 1)] = 1;
	state[getIndex_origin(12, 58, 1)] = 1;
	state[getIndex_destin(12, 34, 1)] = 1;
	state[getIndex_origin(13, 27, 1)] = 1;
	state[getIndex_destin(13, 23, 1)] = 1;
	state[getIndex_origin(14, 34, 1)] = 1;
	state[getIndex_destin(14, 23, 1)] = 1;
	state[getIndex_origin(15, 23, 1)] = 1;
	state[getIndex_destin(15, 38, 1)] = 1;
	state[getIndex_origin(16, 57, 1)] = 1;
	state[getIndex_destin(16, 49, 1)] = 1;
	state[getIndex_origin(17, 53, 1)] = 1;
	state[getIndex_destin(17, 47, 1)] = 1;
	state[getIndex_origin(18, 23, 1)] = 1;
	state[getIndex_destin(18, 44, 1)] = 1;
	state[getIndex_origin(19, 46, 1)] = 1;
	state[getIndex_destin(19, 25, 1)] = 1;
