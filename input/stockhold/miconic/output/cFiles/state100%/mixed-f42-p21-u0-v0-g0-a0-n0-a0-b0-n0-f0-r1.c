...
int main(){
	...
	state[getIndex_origin(0, 29, 1)] = 1;
	state[getIndex_destin(0, 50, 1)] = 1;
	state[getIndex_origin(1, 56, 1)] = 1;
	state[getIndex_destin(1, 59, 1)] = 1;
	state[getIndex_origin(2, 37, 1)] = 1;
	state[getIndex_destin(2, 28, 1)] = 1;
	state[getIndex_origin(3, 34, 1)] = 1;
	state[getIndex_destin(3, 37, 1)] = 1;
	state[getIndex_origin(4, 58, 1)] = 1;
	state[getIndex_destin(4, 40, 1)] = 1;
	state[getIndex_origin(5, 27, 1)] = 1;
	state[getIndex_destin(5, 25, 1)] = 1;
	state[getIndex_origin(6, 50, 1)] = 1;
	state[getIndex_destin(6, 26, 1)] = 1;
	state[getIndex_origin(7, 57, 1)] = 1;
	state[getIndex_destin(7, 28, 1)] = 1;
	state[getIndex_origin(8, 61, 1)] = 1;
	state[getIndex_destin(8, 33, 1)] = 1;
	state[getIndex_origin(9, 57, 1)] = 1;
	state[getIndex_destin(9, 54, 1)] = 1;
	state[getIndex_origin(10, 37, 1)] = 1;
	state[getIndex_destin(10, 38, 1)] = 1;
	state[getIndex_origin(11, 37, 1)] = 1;
	state[getIndex_destin(11, 44, 1)] = 1;
	state[getIndex_origin(12, 21, 1)] = 1;
	state[getIndex_destin(12, 58, 1)] = 1;
	state[getIndex_origin(13, 52, 1)] = 1;
	state[getIndex_destin(13, 30, 1)] = 1;
	state[getIndex_origin(14, 38, 1)] = 1;
	state[getIndex_destin(14, 35, 1)] = 1;
	state[getIndex_origin(15, 59, 1)] = 1;
	state[getIndex_destin(15, 47, 1)] = 1;
	state[getIndex_origin(16, 62, 1)] = 1;
	state[getIndex_destin(16, 52, 1)] = 1;
	state[getIndex_origin(17, 41, 1)] = 1;
	state[getIndex_destin(17, 36, 1)] = 1;
	state[getIndex_origin(18, 59, 1)] = 1;
	state[getIndex_destin(18, 53, 1)] = 1;
	state[getIndex_origin(19, 51, 1)] = 1;
	state[getIndex_destin(19, 52, 1)] = 1;
	state[getIndex_origin(20, 30, 1)] = 1;
	state[getIndex_destin(20, 57, 1)] = 1;
