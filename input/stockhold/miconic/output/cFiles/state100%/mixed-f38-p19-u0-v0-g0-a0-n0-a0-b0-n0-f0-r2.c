...
int main(){
	...
	state[getIndex_origin(1, 55, 1)] = 1;
	state[getIndex_destin(1, 29, 1)] = 1;
	state[getIndex_origin(2, 50, 1)] = 1;
	state[getIndex_destin(2, 29, 1)] = 1;
	...
	state[getIndex_destin(11, 47, 1)] = 1;
	...
	state[getIndex_origin(14, 40, 1)] = 1;
	state[getIndex_destin(14, 48, 1)] = 1;
	state[getIndex_origin(15, 33, 1)] = 1;
	state[getIndex_destin(15, 34, 1)] = 1;
	state[getIndex_origin(16, 24, 1)] = 1;
	state[getIndex_destin(16, 31, 1)] = 1;
	state[getIndex_origin(17, 22, 1)] = 1;
	state[getIndex_destin(17, 34, 1)] = 1;
	state[getIndex_origin(18, 42, 1)] = 1;
