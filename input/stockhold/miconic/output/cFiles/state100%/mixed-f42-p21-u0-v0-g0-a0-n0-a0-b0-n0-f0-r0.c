...
int main(){
	...
	state[getIndex_destin(0, 25, 1)] = 1;
	state[getIndex_origin(1, 30, 1)] = 1;
	state[getIndex_destin(1, 40, 1)] = 1;
	state[getIndex_origin(2, 50, 1)] = 1;
	state[getIndex_destin(2, 52, 1)] = 1;
	state[getIndex_origin(3, 31, 1)] = 1;
	state[getIndex_destin(3, 51, 1)] = 1;
	state[getIndex_origin(4, 36, 1)] = 1;
	state[getIndex_destin(4, 52, 1)] = 1;
	state[getIndex_origin(5, 23, 1)] = 1;
	state[getIndex_destin(5, 40, 1)] = 1;
	state[getIndex_origin(6, 41, 1)] = 1;
	state[getIndex_destin(6, 46, 1)] = 1;
	state[getIndex_origin(7, 62, 1)] = 1;
	state[getIndex_destin(7, 49, 1)] = 1;
	state[getIndex_origin(8, 45, 1)] = 1;
	state[getIndex_destin(8, 57, 1)] = 1;
	state[getIndex_origin(9, 37, 1)] = 1;
	state[getIndex_destin(9, 38, 1)] = 1;
	state[getIndex_origin(10, 35, 1)] = 1;
	state[getIndex_destin(10, 54, 1)] = 1;
	state[getIndex_origin(11, 30, 1)] = 1;
	state[getIndex_destin(11, 23, 1)] = 1;
	state[getIndex_origin(12, 47, 1)] = 1;
	state[getIndex_destin(12, 34, 1)] = 1;
	state[getIndex_origin(13, 22, 1)] = 1;
	state[getIndex_destin(13, 40, 1)] = 1;
	state[getIndex_origin(14, 26, 1)] = 1;
	state[getIndex_destin(14, 21, 1)] = 1;
	state[getIndex_origin(15, 45, 1)] = 1;
	state[getIndex_destin(15, 33, 1)] = 1;
	state[getIndex_origin(16, 38, 1)] = 1;
	state[getIndex_destin(16, 30, 1)] = 1;
	state[getIndex_origin(17, 22, 1)] = 1;
	state[getIndex_destin(17, 49, 1)] = 1;
	state[getIndex_origin(18, 58, 1)] = 1;
	state[getIndex_destin(18, 37, 1)] = 1;
	state[getIndex_origin(19, 36, 1)] = 1;
	state[getIndex_destin(19, 60, 1)] = 1;
	state[getIndex_origin(20, 54, 1)] = 1;
	state[getIndex_destin(20, 56, 1)] = 1;
