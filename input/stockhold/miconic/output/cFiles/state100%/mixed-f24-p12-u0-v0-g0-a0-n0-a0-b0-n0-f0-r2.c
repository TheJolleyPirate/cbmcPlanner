...
int main(){
	...
	state[getIndex_origin(0, 31, 1)] = 1;
	state[getIndex_destin(0, 12, 1)] = 1;
	state[getIndex_origin(1, 16, 1)] = 1;
	state[getIndex_destin(1, 30, 1)] = 1;
	state[getIndex_origin(2, 21, 1)] = 1;
	state[getIndex_destin(2, 18, 1)] = 1;
	state[getIndex_origin(3, 26, 1)] = 1;
	state[getIndex_destin(3, 19, 1)] = 1;
	state[getIndex_origin(4, 27, 1)] = 1;
	state[getIndex_destin(4, 14, 1)] = 1;
	...
	state[getIndex_destin(7, 13, 1)] = 1;
	state[getIndex_origin(8, 27, 1)] = 1;
	state[getIndex_destin(8, 24, 1)] = 1;
	state[getIndex_origin(9, 12, 1)] = 1;
	state[getIndex_destin(9, 13, 1)] = 1;
	state[getIndex_origin(10, 20, 1)] = 1;
