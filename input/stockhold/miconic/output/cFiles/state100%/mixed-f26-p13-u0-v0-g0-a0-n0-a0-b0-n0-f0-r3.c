...
//objects
//object translation:
//objectNames = {p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, f0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15, f16, f17, f18, f19, f20, f21, f22, f23, f24, f25};
...
int main(){
	...
	state[getIndex_above(13, 33, 1)] = 1;
	state[getIndex_above(13, 34, 1)] = 1;
	state[getIndex_above(13, 35, 1)] = 1;
	state[getIndex_above(13, 36, 1)] = 1;
	state[getIndex_above(13, 37, 1)] = 1;
	state[getIndex_above(13, 38, 1)] = 1;
	...
	state[getIndex_above(14, 33, 1)] = 1;
	state[getIndex_above(14, 34, 1)] = 1;
	state[getIndex_above(14, 35, 1)] = 1;
	state[getIndex_above(14, 36, 1)] = 1;
	state[getIndex_above(14, 37, 1)] = 1;
	state[getIndex_above(14, 38, 1)] = 1;
	...
	state[getIndex_origin(0, 36, 1)] = 1;
	state[getIndex_destin(0, 28, 1)] = 1;
	state[getIndex_origin(1, 21, 1)] = 1;
	state[getIndex_destin(1, 16, 1)] = 1;
	state[getIndex_origin(2, 34, 1)] = 1;
	state[getIndex_destin(2, 35, 1)] = 1;
	state[getIndex_origin(3, 14, 1)] = 1;
	state[getIndex_destin(3, 19, 1)] = 1;
	state[getIndex_origin(4, 34, 1)] = 1;
	state[getIndex_destin(4, 17, 1)] = 1;
	state[getIndex_origin(5, 36, 1)] = 1;
	state[getIndex_destin(5, 27, 1)] = 1;
	state[getIndex_origin(6, 19, 1)] = 1;
	state[getIndex_destin(6, 29, 1)] = 1;
	state[getIndex_origin(7, 36, 1)] = 1;
	state[getIndex_destin(7, 37, 1)] = 1;
	state[getIndex_origin(8, 38, 1)] = 1;
	state[getIndex_destin(8, 37, 1)] = 1;
	state[getIndex_origin(9, 31, 1)] = 1;
	state[getIndex_destin(9, 27, 1)] = 1;
	state[getIndex_origin(10, 26, 1)] = 1;
	state[getIndex_destin(10, 15, 1)] = 1;
	state[getIndex_origin(11, 14, 1)] = 1;
	state[getIndex_destin(11, 15, 1)] = 1;
	state[getIndex_origin(12, 23, 1)] = 1;
	state[getIndex_destin(12, 31, 1)] = 1;
	state[getIndex_lift_at(13, 1)] = 1;
