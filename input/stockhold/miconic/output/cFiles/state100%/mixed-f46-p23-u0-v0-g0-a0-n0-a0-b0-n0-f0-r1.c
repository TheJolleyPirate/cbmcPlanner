...
int main(){
	...
	state[getIndex_origin(2, 47, 1)] = 1;
	state[getIndex_destin(2, 58, 1)] = 1;
	state[getIndex_origin(3, 68, 1)] = 1;
	state[getIndex_destin(3, 49, 1)] = 1;
	state[getIndex_origin(4, 34, 1)] = 1;
	state[getIndex_destin(4, 42, 1)] = 1;
	state[getIndex_origin(5, 51, 1)] = 1;
	state[getIndex_destin(5, 59, 1)] = 1;
	state[getIndex_origin(6, 38, 1)] = 1;
	state[getIndex_destin(6, 34, 1)] = 1;
	state[getIndex_origin(7, 49, 1)] = 1;
	state[getIndex_destin(7, 68, 1)] = 1;
	state[getIndex_origin(8, 53, 1)] = 1;
	state[getIndex_destin(8, 59, 1)] = 1;
	state[getIndex_origin(9, 41, 1)] = 1;
	state[getIndex_destin(9, 26, 1)] = 1;
	state[getIndex_origin(10, 47, 1)] = 1;
	state[getIndex_destin(10, 50, 1)] = 1;
	state[getIndex_origin(11, 29, 1)] = 1;
	state[getIndex_destin(11, 32, 1)] = 1;
	state[getIndex_origin(12, 37, 1)] = 1;
	state[getIndex_destin(12, 54, 1)] = 1;
	state[getIndex_origin(13, 46, 1)] = 1;
	state[getIndex_destin(13, 24, 1)] = 1;
	state[getIndex_origin(14, 50, 1)] = 1;
	state[getIndex_destin(14, 67, 1)] = 1;
	state[getIndex_origin(15, 53, 1)] = 1;
	state[getIndex_destin(15, 61, 1)] = 1;
	state[getIndex_origin(16, 42, 1)] = 1;
	state[getIndex_destin(16, 30, 1)] = 1;
	state[getIndex_origin(17, 27, 1)] = 1;
	state[getIndex_destin(17, 66, 1)] = 1;
	state[getIndex_origin(18, 65, 1)] = 1;
	state[getIndex_destin(18, 67, 1)] = 1;
	state[getIndex_origin(19, 41, 1)] = 1;
	state[getIndex_destin(19, 24, 1)] = 1;
	state[getIndex_origin(20, 40, 1)] = 1;
	state[getIndex_destin(20, 23, 1)] = 1;
	state[getIndex_origin(21, 60, 1)] = 1;
	state[getIndex_destin(21, 49, 1)] = 1;
	state[getIndex_origin(22, 29, 1)] = 1;
	state[getIndex_destin(22, 34, 1)] = 1;
