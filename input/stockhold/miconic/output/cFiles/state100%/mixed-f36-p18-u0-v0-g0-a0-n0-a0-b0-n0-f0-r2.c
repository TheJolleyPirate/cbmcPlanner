...
int main(){
	...
	state[getIndex_origin(1, 34, 1)] = 1;
	state[getIndex_destin(1, 36, 1)] = 1;
	...
	state[getIndex_destin(4, 21, 1)] = 1;
	state[getIndex_origin(5, 44, 1)] = 1;
	state[getIndex_destin(5, 41, 1)] = 1;
	state[getIndex_origin(6, 49, 1)] = 1;
	state[getIndex_destin(6, 44, 1)] = 1;
	state[getIndex_origin(7, 36, 1)] = 1;
	state[getIndex_destin(7, 48, 1)] = 1;
	state[getIndex_origin(8, 19, 1)] = 1;
	state[getIndex_destin(8, 45, 1)] = 1;
	state[getIndex_origin(9, 42, 1)] = 1;
	state[getIndex_destin(9, 19, 1)] = 1;
	state[getIndex_origin(10, 26, 1)] = 1;
	state[getIndex_destin(10, 34, 1)] = 1;
	state[getIndex_origin(11, 30, 1)] = 1;
	state[getIndex_destin(11, 35, 1)] = 1;
	state[getIndex_origin(12, 33, 1)] = 1;
	state[getIndex_destin(12, 44, 1)] = 1;
	state[getIndex_origin(13, 24, 1)] = 1;
	state[getIndex_destin(13, 45, 1)] = 1;
	state[getIndex_origin(14, 25, 1)] = 1;
	state[getIndex_destin(14, 48, 1)] = 1;
	state[getIndex_origin(15, 21, 1)] = 1;
	state[getIndex_destin(15, 37, 1)] = 1;
	state[getIndex_origin(16, 28, 1)] = 1;
	state[getIndex_destin(16, 19, 1)] = 1;
	state[getIndex_origin(17, 39, 1)] = 1;
