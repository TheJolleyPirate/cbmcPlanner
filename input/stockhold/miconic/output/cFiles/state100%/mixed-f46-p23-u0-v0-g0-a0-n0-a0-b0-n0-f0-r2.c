...
int main(){
	...
	state[getIndex_origin(0, 32, 1)] = 1;
	state[getIndex_destin(0, 63, 1)] = 1;
	state[getIndex_origin(1, 61, 1)] = 1;
	state[getIndex_destin(1, 57, 1)] = 1;
	state[getIndex_origin(2, 32, 1)] = 1;
	state[getIndex_destin(2, 41, 1)] = 1;
	state[getIndex_origin(3, 49, 1)] = 1;
	state[getIndex_destin(3, 39, 1)] = 1;
	state[getIndex_origin(4, 52, 1)] = 1;
	state[getIndex_destin(4, 30, 1)] = 1;
	state[getIndex_origin(5, 35, 1)] = 1;
	state[getIndex_destin(5, 56, 1)] = 1;
	state[getIndex_origin(6, 48, 1)] = 1;
	state[getIndex_destin(6, 57, 1)] = 1;
	state[getIndex_origin(7, 63, 1)] = 1;
	state[getIndex_destin(7, 29, 1)] = 1;
	state[getIndex_origin(8, 24, 1)] = 1;
	state[getIndex_destin(8, 48, 1)] = 1;
	state[getIndex_origin(9, 47, 1)] = 1;
	state[getIndex_destin(9, 61, 1)] = 1;
	state[getIndex_origin(10, 68, 1)] = 1;
	state[getIndex_destin(10, 33, 1)] = 1;
	state[getIndex_origin(11, 37, 1)] = 1;
	state[getIndex_destin(11, 68, 1)] = 1;
	state[getIndex_origin(12, 38, 1)] = 1;
	state[getIndex_destin(12, 49, 1)] = 1;
	state[getIndex_origin(13, 63, 1)] = 1;
	state[getIndex_destin(13, 68, 1)] = 1;
	state[getIndex_origin(14, 24, 1)] = 1;
	state[getIndex_destin(14, 37, 1)] = 1;
	state[getIndex_origin(15, 26, 1)] = 1;
	state[getIndex_destin(15, 64, 1)] = 1;
	state[getIndex_origin(16, 29, 1)] = 1;
	state[getIndex_destin(16, 54, 1)] = 1;
	state[getIndex_origin(17, 68, 1)] = 1;
	state[getIndex_destin(17, 48, 1)] = 1;
	state[getIndex_origin(18, 34, 1)] = 1;
	state[getIndex_destin(18, 38, 1)] = 1;
	state[getIndex_origin(19, 25, 1)] = 1;
	state[getIndex_destin(19, 41, 1)] = 1;
	state[getIndex_origin(20, 44, 1)] = 1;
	state[getIndex_destin(20, 53, 1)] = 1;
	state[getIndex_origin(21, 61, 1)] = 1;
	state[getIndex_destin(21, 32, 1)] = 1;
	state[getIndex_origin(22, 47, 1)] = 1;
	state[getIndex_destin(22, 67, 1)] = 1;
