...
int main(){
	...
	state[getIndex_destin(2, 23, 1)] = 1;
	state[getIndex_origin(3, 18, 1)] = 1;
	state[getIndex_destin(3, 20, 1)] = 1;
	state[getIndex_origin(4, 17, 1)] = 1;
	state[getIndex_destin(4, 21, 1)] = 1;
	state[getIndex_origin(5, 18, 1)] = 1;
	state[getIndex_destin(5, 19, 1)] = 1;
	state[getIndex_origin(6, 10, 1)] = 1;
	state[getIndex_destin(6, 19, 1)] = 1;
	state[getIndex_origin(7, 11, 1)] = 1;
	state[getIndex_destin(7, 14, 1)] = 1;
