...
int main(){
	...
	state[getIndex_destin(0, 24, 1)] = 1;
	state[getIndex_origin(1, 36, 1)] = 1;
	state[getIndex_destin(1, 31, 1)] = 1;
	state[getIndex_origin(2, 17, 1)] = 1;
	state[getIndex_destin(2, 20, 1)] = 1;
	state[getIndex_origin(3, 34, 1)] = 1;
	state[getIndex_destin(3, 25, 1)] = 1;
	state[getIndex_origin(4, 42, 1)] = 1;
	state[getIndex_destin(4, 22, 1)] = 1;
	state[getIndex_origin(5, 21, 1)] = 1;
	state[getIndex_destin(5, 45, 1)] = 1;
	state[getIndex_origin(6, 20, 1)] = 1;
	state[getIndex_destin(6, 48, 1)] = 1;
	state[getIndex_origin(7, 33, 1)] = 1;
	state[getIndex_destin(7, 42, 1)] = 1;
	state[getIndex_origin(8, 21, 1)] = 1;
	state[getIndex_destin(8, 31, 1)] = 1;
	state[getIndex_origin(9, 27, 1)] = 1;
	state[getIndex_destin(9, 48, 1)] = 1;
	state[getIndex_origin(10, 25, 1)] = 1;
	state[getIndex_destin(10, 48, 1)] = 1;
	state[getIndex_origin(11, 25, 1)] = 1;
	state[getIndex_destin(11, 40, 1)] = 1;
	state[getIndex_origin(12, 27, 1)] = 1;
	state[getIndex_destin(12, 32, 1)] = 1;
	state[getIndex_origin(13, 50, 1)] = 1;
	state[getIndex_destin(13, 20, 1)] = 1;
	state[getIndex_origin(14, 42, 1)] = 1;
	state[getIndex_destin(14, 43, 1)] = 1;
	state[getIndex_origin(15, 35, 1)] = 1;
	state[getIndex_destin(15, 39, 1)] = 1;
	state[getIndex_origin(16, 24, 1)] = 1;
	state[getIndex_destin(16, 20, 1)] = 1;
