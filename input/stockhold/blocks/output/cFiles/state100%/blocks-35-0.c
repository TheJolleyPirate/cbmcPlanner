...
//objects
//object translation:
//objectNames = {a1, f, x, i1, h1, d, j, w, b1, g1, q, o, z, s, b, i, r, u, v, c, c1, k, e1, h, f1, g, p, l, n, a, t, m, d1, y, e};
...
int main(){
	...
	state[getIndex_on(32, 7, 1)] = 1;
	state[getIndex_on(3, 33, 1)] = 1;
	state[getIndex_on(33, 34, 1)] = 1;
	state[getIndex_on(34, 8, 1)] = 1;
	state[getIndex_on(4, 9, 1)] = 1;
	state[getIndex_handempty(1)] = 1;
	...
	while(1 == 1){
		...
		if(state[getIndex_on(20, 23, 0)] && state[getIndex_on(23, 24, 0)] && state[getIndex_on(24, 26, 0)] && state[getIndex_on(26, 11, 0)] && state[getIndex_on(11, 28, 0)] && state[getIndex_on(28, 13, 0)] && state[getIndex_on(13, 27, 0)] && state[getIndex_on(27, 10, 0)] && state[getIndex_on(10, 16, 0)] && state[getIndex_on(16, 14, 0)] && state[getIndex_on(14, 12, 0)] && state[getIndex_on(12, 2, 0)] && state[getIndex_on(2, 9, 0)] && state[getIndex_on(9, 4, 0)] && state[getIndex_on(4, 31, 0)] && state[getIndex_on(31, 32, 0)] && state[getIndex_on(32, 34, 0)] && state[getIndex_on(34, 25, 0)] && state[getIndex_on(25, 19, 0)] && state[getIndex_on(19, 1, 0)] && state[getIndex_on(1, 22, 0)] && state[getIndex_on(22, 29, 0)] && state[getIndex_on(29, 3, 0)] && state[getIndex_on(3, 0, 0)] && state[getIndex_on(0, 15, 0)] && state[getIndex_on(15, 33, 0)] && state[getIndex_on(33, 18, 0)] && state[getIndex_on(18, 6, 0)] && state[getIndex_on(6, 17, 0)] && state[getIndex_on(17, 7, 0)] && state[getIndex_on(7, 8, 0)] && state[getIndex_on(8, 30, 0)] && state[getIndex_on(30, 5, 0)] && state[getIndex_on(5, 21, 0)]){
