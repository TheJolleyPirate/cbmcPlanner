...
int main(){
	...
	while(1 == 1){
		...
		if((state[getIndex_on(4, 2, 0)] && state[getIndex_on(2, 7, 0)] && state[getIndex_on(7, 5, 0)] && state[getIndex_on(5, 0, 0)] && state[getIndex_on(0, 1, 0)] && state[getIndex_on(1, 8, 0)] && state[getIndex_on(8, 6, 0)] && state[getIndex_on(6, 3, 0)])){
