...
//objects
//object translation:
//objectNames = {p, h, m, c, x, q, e, b, z, n, r, v, k, a1, j, g, i, d, s, y, f, a, l, o, b1, w, t, u};
...
int main(){
	...
	state[getIndex_on(26, 23, 1)] = 1;
	state[getIndex_on(25, 9, 1)] = 1;
	...
	while(1 == 1){
		...
		if(state[getIndex_on(21, 4, 0)] && state[getIndex_on(4, 20, 0)] && state[getIndex_on(20, 6, 0)] && state[getIndex_on(6, 2, 0)] && state[getIndex_on(2, 0, 0)] && state[getIndex_on(0, 1, 0)] && state[getIndex_on(1, 15, 0)] && state[getIndex_on(15, 24, 0)] && state[getIndex_on(24, 27, 0)] && state[getIndex_on(27, 13, 0)] && state[getIndex_on(13, 23, 0)] && state[getIndex_on(23, 7, 0)] && state[getIndex_on(7, 10, 0)] && state[getIndex_on(10, 22, 0)] && state[getIndex_on(22, 26, 0)] && state[getIndex_on(26, 25, 0)] && state[getIndex_on(25, 8, 0)] && state[getIndex_on(8, 16, 0)] && state[getIndex_on(16, 17, 0)] && state[getIndex_on(17, 9, 0)] && state[getIndex_on(9, 18, 0)] && state[getIndex_on(18, 11, 0)] && state[getIndex_on(11, 19, 0)] && state[getIndex_on(19, 5, 0)] && state[getIndex_on(5, 3, 0)] && state[getIndex_on(3, 14, 0)] && state[getIndex_on(14, 12, 0)]){
