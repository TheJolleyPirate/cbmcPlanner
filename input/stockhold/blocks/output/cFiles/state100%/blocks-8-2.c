...
int main(){
	...
	while(1 == 1){
		...
		if((state[getIndex_on(3, 1, 0)] && state[getIndex_on(1, 5, 0)] && state[getIndex_on(5, 2, 0)] && state[getIndex_on(2, 0, 0)] && state[getIndex_on(0, 6, 0)] && state[getIndex_on(6, 7, 0)] && state[getIndex_on(7, 4, 0)])){
