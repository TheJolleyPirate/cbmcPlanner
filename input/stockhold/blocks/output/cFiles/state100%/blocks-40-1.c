...
//objects
//object translation:
//objectNames = {z, y, d, n, n1, l1, t, g, i1, l, u, j, a1, h1, b, e, p, m1, q, o, w, f1, b1, r, k, v, h, c, i, d1, e1, j1, g1, c1, s, x, f, a, m, k1};
...
int main(){
	...
	state[getIndex_on(0, 3, 1)] = 1;
	state[getIndex_on(3, 4, 1)] = 1;
	...
	while(1 == 1){
		...
		if(state[getIndex_on(4, 28, 0)] && state[getIndex_on(28, 5, 0)] && state[getIndex_on(5, 2, 0)] && state[getIndex_on(2, 18, 0)] && state[getIndex_on(18, 12, 0)] && state[getIndex_on(12, 25, 0)] && state[getIndex_on(25, 22, 0)] && state[getIndex_on(22, 11, 0)] && state[getIndex_on(11, 3, 0)] && state[getIndex_on(3, 27, 0)] && state[getIndex_on(27, 38, 0)] && state[getIndex_on(38, 34, 0)] && state[getIndex_on(34, 39, 0)] && state[getIndex_on(39, 10, 0)] && state[getIndex_on(10, 0, 0)] && state[getIndex_on(0, 9, 0)] && state[getIndex_on(9, 36, 0)] && state[getIndex_on(36, 20, 0)] && state[getIndex_on(20, 35, 0)] && state[getIndex_on(35, 31, 0)] && state[getIndex_on(31, 30, 0)] && state[getIndex_on(30, 7, 0)] && state[getIndex_on(7, 37, 0)] && state[getIndex_on(37, 19, 0)] && state[getIndex_on(19, 6, 0)] && state[getIndex_on(6, 26, 0)] && state[getIndex_on(26, 21, 0)] && state[getIndex_on(21, 8, 0)] && state[getIndex_on(8, 16, 0)] && state[getIndex_on(16, 32, 0)] && state[getIndex_on(32, 24, 0)] && state[getIndex_on(24, 1, 0)] && state[getIndex_on(1, 13, 0)] && state[getIndex_on(13, 14, 0)] && state[getIndex_on(14, 33, 0)] && state[getIndex_on(33, 17, 0)] && state[getIndex_on(17, 15, 0)] && state[getIndex_on(15, 29, 0)] && state[getIndex_on(29, 23, 0)]){
